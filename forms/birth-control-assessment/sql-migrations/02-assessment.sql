-- 02_assessment.sql
-- Top-level birth control assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Birth control assessment form using UK MEC categories. Parent entity for all assessment sections.';
