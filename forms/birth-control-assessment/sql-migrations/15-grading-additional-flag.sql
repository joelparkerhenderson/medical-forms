...
-- Additional safety-critical flags detected during birth control assessment grading.
...
COMMENT ON TABLE grading_additional_flag IS
    'Additional safety-critical flags detected during birth control assessment grading (e.g. UK MEC 4 contraindications, DVT risk).';
...
COMMENT ON COLUMN grading_additional_flag.flag_id IS
    'Identifier of the flag (e.g. FLAG-DVT-001, FLAG-MIGRAINE-001).';
COMMENT ON COLUMN grading_additional_flag.category IS
    'Category of the flag (e.g. Thromboembolism, Cardiovascular, Hormonal).';
