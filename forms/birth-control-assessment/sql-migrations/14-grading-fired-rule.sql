...
-- Individual UK MEC rules that fired during grading.
...
COMMENT ON TABLE grading_fired_rule IS
    'Individual UK MEC rules that evaluated to true during grading.';
...
COMMENT ON COLUMN grading_fired_rule.rule_id IS
    'Identifier of the rule that fired (e.g. MEC-DVT-001, MEC-BP-002).';
COMMENT ON COLUMN grading_fired_rule.category IS
    'Category of the rule (e.g. Thromboembolism, Cardiovascular, Migraine).';
