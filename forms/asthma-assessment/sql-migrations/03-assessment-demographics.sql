...
-- Demographics section of the asthma assessment.
...
COMMENT ON COLUMN assessment_demographics.occupation IS
    'Patient occupation, relevant for occupational asthma assessment.';
COMMENT ON COLUMN assessment_demographics.postcode IS
    'Patient postal code.';
COMMENT ON COLUMN assessment_demographics.age_at_diagnosis IS
    'Age when asthma was first diagnosed, NULL if unanswered.';
