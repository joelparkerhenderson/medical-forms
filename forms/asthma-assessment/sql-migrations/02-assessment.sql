-- 02_assessment.sql
-- Top-level asthma assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Asthma assessment form using the Asthma Control Test (ACT) instrument. Parent entity for all assessment sections.';
