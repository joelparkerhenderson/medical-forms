...
-- Computed PREVENT risk grading result (1:1 with assessment).
-- ============================================================
-- Stores the output of the PREVENT risk grading engine.
-- Created when the patient submits the questionnaire and the
-- engine computes the 10-year and 30-year CVD risk estimates.
-- ============================================================
