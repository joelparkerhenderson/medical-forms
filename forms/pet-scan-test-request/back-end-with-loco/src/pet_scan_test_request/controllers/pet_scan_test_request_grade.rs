...
use crate::models::_entities::pet_scan_test_request_grades::{ActiveModel, Entity, Model};
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.pet_scan_test_request_id = Set(self.pet_scan_test_request_id);
...
pub fn routes() -> Routes {
    Routes::new()
        .prefix("api/pet_scan_test_request_grades/")
        .add("/", get(list))
        .add("/", post(add))
        .add("{id}", get(get_one))
