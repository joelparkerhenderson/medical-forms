-- ============================================================
-- 13_casualty_card_primary_survey.sql
-- ABCDE primary survey (1:1 with casualty_card).
-- ============================================================
-- Structured primary survey following the Airway, Breathing,
-- Circulation, Disability, Exposure (ABCDE) framework used
-- in emergency assessment. Includes GCS scoring.
-- ============================================================
...
CREATE TRIGGER trg_casualty_card_primary_survey_updated_at
