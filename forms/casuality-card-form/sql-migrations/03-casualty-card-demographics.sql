-- ============================================================
-- 03_casualty_card_demographics.sql
-- Demographics subsection (1:1 with casualty_card).
-- ============================================================
-- Stores assessment-time demographic data that supplements
-- the static identity in the patient table. These fields
-- may differ from the patient record at the time of attendance.
-- ============================================================
...
CREATE TRIGGER trg_casualty_card_demographics_updated_at
