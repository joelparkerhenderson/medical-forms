-- ============================================================
-- 11_casualty_card_allergy.sql
-- Allergies (many-to-one with casualty_card).
-- ============================================================
-- Each row is one documented allergy. Anaphylaxis severity
-- triggers a safety flag in the flagged issues engine.
-- ============================================================
...
CREATE TRIGGER trg_casualty_card_allergy_updated_at
