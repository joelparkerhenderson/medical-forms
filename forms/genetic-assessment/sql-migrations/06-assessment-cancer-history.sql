-- 06_assessment_cancer_history.sql
-- Cancer history section of the genetic assessment.
...
CREATE TRIGGER trg_assessment_cancer_history_updated_at
...
CREATE TRIGGER trg_assessment_cancer_history_item_updated_at
