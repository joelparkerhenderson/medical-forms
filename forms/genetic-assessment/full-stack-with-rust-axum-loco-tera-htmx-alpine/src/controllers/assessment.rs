...
use crate::engine::{genetic_grader, flagged_issues, types::AssessmentData};
use crate::models::{
...
fn section_to_json(section: &str) -> &str {
    match section {
        ...
        "family_pedigree" => "familyPedigree",
        "personal_medical_history" => "personalMedicalHistory",
        "cancer_risk_assessment" => "cancerRiskAssessment",
        "cardiac_genetic_risk" => "cardiacGeneticRisk",
        "reproductive_genetics" => "reproductiveGenetics",
        "genetic_testing_status" => "geneticTestingStatus",
...
fn is_string_field(field: &str) -> bool {
    matches!(
        ...
        "patientName"
            ...
            | "urgency"
            | "referralDate"
            | "maternalGrandmotherConditions"
            | "maternalGrandmotherCancers"
            | "maternalGrandmotherAgeAtDiagnosis"
            | "maternalGrandmotherDeceased"
            | "maternalGrandfatherConditions"
            | "maternalGrandfatherCancers"
            | "maternalGrandfatherAgeAtDiagnosis"
            | "maternalGrandfatherDeceased"
            | "paternalGrandmotherConditions"
            | "paternalGrandmotherCancers"
            | "paternalGrandmotherAgeAtDiagnosis"
            | "paternalGrandmotherDeceased"
            | "paternalGrandfatherConditions"
            | "paternalGrandfatherCancers"
            | "paternalGrandfatherAgeAtDiagnosis"
            | "paternalGrandfatherDeceased"
            | "motherConditions"
            | "motherCancers"
            | "motherAgeAtDiagnosis"
            | "motherDeceased"
            | "fatherConditions"
            | "fatherCancers"
            | "fatherAgeAtDiagnosis"
            | "fatherDeceased"
            | "siblingsDetails"
            | "childrenDetails"
...
async fn show_report(
    ...
    let (risk_level, risk_score, fired_rules) =
        genetic_grader::calculate_risk(&assessment_data);
