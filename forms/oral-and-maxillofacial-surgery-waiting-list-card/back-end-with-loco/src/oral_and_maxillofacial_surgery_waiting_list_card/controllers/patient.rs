...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.preferred_language_as_iso_639_1 = Set(self.preferred_language_as_iso_639_1.clone());
      item.interpreter_required = Set(self.interpreter_required.clone());
      item.accessibility_needs = Set(self.accessibility_needs.clone());
      item.preferred_contact_channel = Set(self.preferred_contact_channel.clone());
      }
}
