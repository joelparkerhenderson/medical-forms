...
#[sea_orm(table_name = "omfs_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::omfs_waiting_list_card_appointments::Entity")]
    OmfsWaitingListCardAppointments,
    #[sea_orm(has_many = "super::omfs_waiting_list_card_grades::Entity")]
...
impl Related<super::omfs_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::OmfsWaitingListCardAppointments.def()
    }
}
