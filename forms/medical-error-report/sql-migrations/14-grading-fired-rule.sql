...
-- Individual severity rules that fired during grading.
...
COMMENT ON TABLE grading_fired_rule IS
    'Individual severity rules that evaluated to true during grading.';
...
COMMENT ON COLUMN grading_fired_rule.rule_id IS
    'Identifier of the rule that fired (e.g. SEV-001, CF-002).';
COMMENT ON COLUMN grading_fired_rule.category IS
    'Category of the rule (e.g. Severity, Contributing Factors, Outcome).';
