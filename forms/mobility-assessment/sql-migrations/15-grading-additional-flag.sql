...
-- Additional safety-critical flags detected during mobility assessment grading.
...
COMMENT ON TABLE grading_additional_flag IS
    'Additional safety-critical flags detected during mobility assessment grading (e.g. high fall risk, recurrent falls, polypharmacy).';
...
COMMENT ON COLUMN grading_additional_flag.flag_id IS
    'Identifier of the flag (e.g. FLAG-FALL-001, FLAG-POLY-001, FLAG-TUG-001).';
COMMENT ON COLUMN grading_additional_flag.category IS
    'Category of the flag (e.g. Fall Risk, Polypharmacy, Device, Functional Decline).';
