-- 02_assessment.sql
-- Top-level mobility assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Mobility assessment form using the Tinetti Assessment Tool (Performance-Oriented Mobility Assessment). Parent entity for all assessment sections.';
