# MRI Scan Test Result — specification
...
- `bin/test-form mri-scan-test-result` exits cleanly.
...
- `bin/lily-html-refactor --check mri-scan-test-result` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `mri-scan-test-result.front-end-with-html.v1` (HTML)
  - `mri-scan-test-result.front-end-with-svelte.v1` (SvelteKit)
