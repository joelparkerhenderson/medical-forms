...
#[sea_orm(table_name = "mri_scan_test_results")]
pub struct Model {
...
pub enum Relation {
    ...
    Clinicians,
    #[sea_orm(has_many = "super::mri_scan_test_result_grades::Entity")]
    MriScanTestResultGrades,
    #[sea_orm(
...
impl Related<super::mri_scan_test_result_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::MriScanTestResultGrades.def()
    }
}
