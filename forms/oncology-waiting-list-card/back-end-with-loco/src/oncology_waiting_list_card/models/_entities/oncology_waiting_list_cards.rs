...
#[sea_orm(table_name = "oncology_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::oncology_waiting_list_card_appointments::Entity")]
    OncologyWaitingListCardAppointments,
    #[sea_orm(has_many = "super::oncology_waiting_list_card_grades::Entity")]
    OncologyWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::oncology_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::OncologyWaitingListCardAppointments.def()
    }
}

impl Related<super::oncology_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::OncologyWaitingListCardGrades.def()
    }
}
