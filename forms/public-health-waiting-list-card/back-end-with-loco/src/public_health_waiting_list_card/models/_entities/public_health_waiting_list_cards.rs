...
#[sea_orm(table_name = "public_health_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::public_health_waiting_list_card_appointments::Entity")]
    PublicHealthWaitingListCardAppointments,
    #[sea_orm(has_many = "super::public_health_waiting_list_card_grades::Entity")]
...
impl Related<super::public_health_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::PublicHealthWaitingListCardAppointments.def()
    }
}
