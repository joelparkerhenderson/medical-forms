...
use crate::models::_entities::public_health_waiting_list_card_appointments::{ActiveModel, Entity, Model};
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.public_health_waiting_list_card_id = Set(self.public_health_waiting_list_card_id);
...
pub fn routes() -> Routes {
    Routes::new()
        .prefix("api/public_health_waiting_list_card_appointments/")
        .add("/", get(list))
        .add("/", post(add))
        .add("{id}", get(get_one))
