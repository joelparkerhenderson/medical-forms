...
impl Hooks for App {
    ...
    fn routes(_ctx: &AppContext) -> AppRoutes {
        AppRoutes::with_default_routes() // controller routes below
            ...
            .add_route(controllers::apgar_score_grade_flag::routes())
            .add_route(controllers::apgar_score_grade_rule::routes())
            .add_route(controllers::apgar_score_grade::routes())
            .add_route(controllers::apgar_score_timepoint::routes())
            .add_route(controllers::apgar_score::routes())
