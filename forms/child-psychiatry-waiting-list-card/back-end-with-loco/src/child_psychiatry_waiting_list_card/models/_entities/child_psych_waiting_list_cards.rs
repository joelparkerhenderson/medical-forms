...
#[sea_orm(table_name = "child_psych_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::child_psych_waiting_list_card_appointments::Entity")]
    ChildPsychWaitingListCardAppointments,
    #[sea_orm(has_many = "super::child_psych_waiting_list_card_grades::Entity")]
    ChildPsychWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::child_psych_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::ChildPsychWaitingListCardAppointments.def()
    }
}

impl Related<super::child_psych_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::ChildPsychWaitingListCardGrades.def()
    }
}
