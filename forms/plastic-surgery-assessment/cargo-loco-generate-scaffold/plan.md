...
Generate Loco (loco.rs) scaffolding for the `plastic-surgery-assessment` form.
...
1. Create a new Loco project (one-time):
   ...
   ```sh
   loco new --name plastic-surgery-assessment --db postgres --bg async --assets serverside
   ```
