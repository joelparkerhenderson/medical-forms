-- 02_assessment.sql
-- Top-level plastic surgery assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Plastic surgery assessment form using ASA Physical Status, Wound Classification, and Surgical Complexity scoring. Parent entity for all assessment sections.';
