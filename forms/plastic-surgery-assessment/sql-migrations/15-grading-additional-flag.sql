...
-- Additional safety-critical flags detected during plastic surgery assessment grading.
...
COMMENT ON TABLE grading_additional_flag IS
    'Additional safety-critical flags detected during plastic surgery assessment grading (e.g. body dysmorphia, difficult airway, immunosuppression).';
...
COMMENT ON COLUMN grading_additional_flag.flag_id IS
    'Identifier of the flag (e.g. FLAG-BDD-001, FLAG-AIRWAY-001).';
COMMENT ON COLUMN grading_additional_flag.category IS
    'Category of the flag (e.g. Psychological, Anaesthetic, Wound, Allergy).';
