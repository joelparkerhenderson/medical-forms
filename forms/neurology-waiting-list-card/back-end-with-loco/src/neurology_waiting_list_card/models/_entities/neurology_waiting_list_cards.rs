...
#[sea_orm(table_name = "neurology_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::neurology_waiting_list_card_appointments::Entity")]
    NeurologyWaitingListCardAppointments,
    #[sea_orm(has_many = "super::neurology_waiting_list_card_grades::Entity")]
    NeurologyWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::neurology_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::NeurologyWaitingListCardAppointments.def()
    }
}

impl Related<super::neurology_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::NeurologyWaitingListCardGrades.def()
    }
}
