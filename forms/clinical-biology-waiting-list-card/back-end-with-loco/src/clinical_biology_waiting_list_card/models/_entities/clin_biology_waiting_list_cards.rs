...
#[sea_orm(table_name = "clin_biology_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::clin_biology_waiting_list_card_appointments::Entity")]
    ClinBiologyWaitingListCardAppointments,
    #[sea_orm(has_many = "super::clin_biology_waiting_list_card_grades::Entity")]
...
impl Related<super::clin_biology_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::ClinBiologyWaitingListCardAppointments.def()
    }
}
