...
COMMENT ON TABLE patient IS
    'Patient demographic information identified at the pre-op clinic.';
...
COMMENT ON COLUMN patient.weight_kg IS
    'Patient weight in kilograms (clinician-measured).';
COMMENT ON COLUMN patient.height_cm IS
    'Patient height in centimetres (clinician-measured).';
COMMENT ON COLUMN patient.bmi IS
    'Body mass index, auto-calculated from weight and height.';
