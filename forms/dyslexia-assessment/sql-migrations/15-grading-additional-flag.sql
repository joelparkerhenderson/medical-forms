...
-- Additional flags detected during dyslexia assessment grading.
...
COMMENT ON TABLE grading_additional_flag IS
    'Additional flags detected during dyslexia assessment grading (e.g. severe phonological deficit, co-occurring conditions).';
...
COMMENT ON COLUMN grading_additional_flag.flag_id IS
    'Identifier of the flag (e.g. FLAG-PHON-001, FLAG-WM-001).';
COMMENT ON COLUMN grading_additional_flag.category IS
    'Category of the flag (e.g. Phonological, Reading, Emotional).';
