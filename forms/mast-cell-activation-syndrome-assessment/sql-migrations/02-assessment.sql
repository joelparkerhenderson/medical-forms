-- 02_assessment.sql
-- Top-level MCAS assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Mast Cell Activation Syndrome (MCAS) assessment form. Parent entity for all assessment sections.';
