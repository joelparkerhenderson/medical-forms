...
#[sea_orm(table_name = "pathology_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::pathology_waiting_list_card_appointments::Entity")]
    PathologyWaitingListCardAppointments,
    #[sea_orm(has_many = "super::pathology_waiting_list_card_grades::Entity")]
...
impl Related<super::pathology_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::PathologyWaitingListCardAppointments.def()
    }
}
