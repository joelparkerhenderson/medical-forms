...
#[sea_orm(table_name = "rad_onc_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::rad_onc_waiting_list_card_appointments::Entity")]
    RadOncWaitingListCardAppointments,
    #[sea_orm(has_many = "super::rad_onc_waiting_list_card_grades::Entity")]
    RadOncWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::rad_onc_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::RadOncWaitingListCardAppointments.def()
    }
}

impl Related<super::rad_onc_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::RadOncWaitingListCardGrades.def()
    }
}
