...
#[sea_orm(table_name = "gen_practice_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::gen_practice_waiting_list_card_appointments::Entity")]
    GenPracticeWaitingListCardAppointments,
    #[sea_orm(has_many = "super::gen_practice_waiting_list_card_grades::Entity")]
    GenPracticeWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::gen_practice_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::GenPracticeWaitingListCardAppointments.def()
    }
}

impl Related<super::gen_practice_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::GenPracticeWaitingListCardGrades.def()
    }
}
