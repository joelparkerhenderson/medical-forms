-- 02_assessment.sql
-- Top-level nutrition assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Nutrition assessment form using MUST (Malnutrition Universal Screening Tool). Parent entity for all assessment sections.';
