...
-- Additional safety-critical flags detected during nutrition assessment grading.
...
COMMENT ON TABLE grading_additional_flag IS
    'Additional safety-critical flags detected during nutrition assessment grading (e.g. refeeding risk, severe dysphagia, critical malnutrition).';
...
COMMENT ON COLUMN grading_additional_flag.flag_id IS
    'Identifier of the flag (e.g. FLAG-REFEED-001, FLAG-DYS-001).';
COMMENT ON COLUMN grading_additional_flag.category IS
    'Category of the flag (e.g. Refeeding Risk, Dysphagia, Allergy, Malnutrition).';
