...
-- Individual nutritional screening rules that fired during grading.
...
COMMENT ON TABLE grading_fired_rule IS
    'Individual nutritional screening rules that evaluated to true during grading.';
...
COMMENT ON COLUMN grading_fired_rule.rule_id IS
    'Identifier of the rule that fired (e.g. MUST-001, DYS-001, GI-001).';
COMMENT ON COLUMN grading_fired_rule.category IS
    'Category of the rule (e.g. MUST Screening, Dysphagia, Gastrointestinal, Allergy).';
