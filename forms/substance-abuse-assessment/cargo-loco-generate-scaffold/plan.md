...
Generate Loco (loco.rs) scaffolding for the `substance-abuse-assessment` form.
...
1. Create a new Loco project (one-time):
   ...
   ```sh
   loco new --name substance-abuse-assessment --db postgres --bg async --assets serverside
   ```
