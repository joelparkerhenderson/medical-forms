-- 02_assessment.sql
-- Top-level substance abuse assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Substance abuse assessment form using AUDIT and DAST-10 screening instruments. Parent entity for all assessment sections.';
