...
-- Individual substance abuse rules that fired during grading.
...
COMMENT ON TABLE grading_fired_rule IS
    'Individual substance abuse rules that evaluated to true during grading.';
...
COMMENT ON COLUMN grading_fired_rule.rule_id IS
    'Identifier of the rule that fired (e.g. AUDIT-001, DAST-001, WD-001).';
COMMENT ON COLUMN grading_fired_rule.category IS
    'Category of the rule (e.g. Alcohol, Drug, Withdrawal, Mental Health).';
