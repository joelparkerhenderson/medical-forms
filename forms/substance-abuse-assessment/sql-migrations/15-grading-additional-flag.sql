...
-- Additional safety-critical flags detected during substance abuse assessment grading.
...
COMMENT ON TABLE grading_additional_flag IS
    'Additional safety-critical flags detected during substance abuse assessment grading (e.g. active withdrawal, overdose risk, suicidal ideation).';
...
COMMENT ON COLUMN grading_additional_flag.flag_id IS
    'Identifier of the flag (e.g. FLAG-WD-001, FLAG-OD-001, FLAG-SI-001).';
COMMENT ON COLUMN grading_additional_flag.category IS
    'Category of the flag (e.g. Withdrawal, Overdose, Suicidality, Safeguarding).';
