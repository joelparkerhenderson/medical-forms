...
#[sea_orm(table_name = "cardiology_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::cardiology_waiting_list_card_appointments::Entity")]
    CardiologyWaitingListCardAppointments,
    #[sea_orm(has_many = "super::cardiology_waiting_list_card_grades::Entity")]
    CardiologyWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::cardiology_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::CardiologyWaitingListCardAppointments.def()
    }
}

impl Related<super::cardiology_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::CardiologyWaitingListCardGrades.def()
    }
}
