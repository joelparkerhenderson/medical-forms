...
use crate::models::_entities::modified_early_warning_scores::{ActiveModel, Entity, Model};
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.consciousness_avpu = Set(self.consciousness_avpu.clone());
      item.previous_mews_score = Set(self.previous_mews_score);
...
pub fn routes() -> Routes {
    Routes::new()
        .prefix("api/modified_early_warning_scores/")
        .add("/", get(list))
        .add("/", post(add))
        .add("{id}", get(get_one))
