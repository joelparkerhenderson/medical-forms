-- 02_assessment.sql
-- Top-level contraception assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Contraception assessment form using UKMEC (UK Medical Eligibility Criteria). Parent entity for all assessment sections.';
