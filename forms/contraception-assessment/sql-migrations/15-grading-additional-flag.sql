...
-- Additional clinical flags detected during contraception assessment grading.
...
COMMENT ON TABLE grading_additional_flag IS
    'Additional clinical flags detected during contraception assessment grading (e.g. absolute contraindications, screening overdue, safeguarding).';
...
COMMENT ON COLUMN grading_additional_flag.flag_id IS
    'Identifier of the flag (e.g. FLAG-VTE-001, FLAG-SCREEN-001, FLAG-PREG-001).';
COMMENT ON COLUMN grading_additional_flag.category IS
    'Category of the flag (e.g. Contraindication, Screening, Safeguarding, Pregnancy).';
