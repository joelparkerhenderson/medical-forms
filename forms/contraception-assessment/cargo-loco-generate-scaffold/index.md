# contraception-assessment — cargo-loco-generate-scaffold

Generator scripts that produce the Loco (loco.rs) scaffolding for
the `contraception-assessment` form's full-stack Rust backend.
...
- `assessment_reproductive_history`
- `assessment_menstrual_history`
- `assessment_current_contraception`
- `assessment_medical_history`
- `assessment_cardiovascular_risk`
- `assessment_lifestyle_factors`
- `assessment_preferences_priorities`
- `assessment_breast_cervical_screening`
- `assessment_family_planning_goals`
- `grading_result`
- `grading_fired_rule`
