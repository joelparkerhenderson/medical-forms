-- 02_assessment.sql
-- Top-level SCORE2-Diabetes assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'SCORE2-Diabetes assessment form. Parent entity for all assessment sections.';
