...
Generate Loco (loco.rs) scaffolding for the `systematic-coronary-risk-evaluation-2-diabetes` form.
...
1. Create a new Loco project (one-time):
   ...
   ```sh
   loco new --name systematic-coronary-risk-evaluation-2-diabetes --db postgres --bg async --assets serverside
   ```
