-- 02_assessment.sql
-- Top-level urology assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Urology assessment form using IPSS scoring. Parent entity for all assessment sections.';
