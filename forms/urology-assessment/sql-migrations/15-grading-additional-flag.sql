...
-- Additional safety-critical flags detected during urology grading.
...
COMMENT ON TABLE grading_additional_flag IS
    'Additional safety-critical flags detected during urology assessment grading.';
...
COMMENT ON COLUMN grading_additional_flag.flag_id IS
    'Identifier of the flag (e.g. FLAG-PSA-001, FLAG-HAEM-001, FLAG-RET-001).';
COMMENT ON COLUMN grading_additional_flag.category IS
    'Category of the flag (e.g. PSA Elevation, Haematuria, Urinary Retention, Renal Function).';
