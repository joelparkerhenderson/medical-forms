# urology-assessment — cargo-loco-generate-scaffold

Generator scripts that produce the Loco (loco.rs) scaffolding for
the `urology-assessment` form's full-stack Rust backend.
