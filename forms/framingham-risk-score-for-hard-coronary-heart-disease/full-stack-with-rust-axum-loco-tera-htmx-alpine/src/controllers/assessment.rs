...
async fn show_report(
    ...
    // Run grading engine
    let (risk_category, ten_year_risk_percent, fired_rules) =
    ...
    context.insert("risk_label", &crate::engine::utils::risk_level_label(&risk_category));
    context.insert("ten_year_risk_percent", &ten_year_risk_percent);
