...
-- changeset legal-requirements-privacy-notice:02-acknowledgment
...
COMMENT ON TABLE acknowledgment IS 'Patient acknowledgment of the legal requirements privacy notice.';
