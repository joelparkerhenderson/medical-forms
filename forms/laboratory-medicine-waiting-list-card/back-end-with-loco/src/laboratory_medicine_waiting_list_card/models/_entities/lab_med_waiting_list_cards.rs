...
#[sea_orm(table_name = "lab_med_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::lab_med_waiting_list_card_appointments::Entity")]
    LabMedWaitingListCardAppointments,
    #[sea_orm(has_many = "super::lab_med_waiting_list_card_grades::Entity")]
    LabMedWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::lab_med_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::LabMedWaitingListCardAppointments.def()
    }
}

impl Related<super::lab_med_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::LabMedWaitingListCardGrades.def()
    }
}
