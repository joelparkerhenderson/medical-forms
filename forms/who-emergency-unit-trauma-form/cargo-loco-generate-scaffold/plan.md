...
Generate Loco (loco.rs) scaffolding for the `who-emergency-unit-trauma-form` form.
...
1. Create a new Loco project (one-time):
   ...
   ```sh
   loco new --name who-emergency-unit-trauma-form --db postgres --bg async --assets serverside
   ```
