...
#[sea_orm(table_name = "immunology_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::immunology_waiting_list_card_appointments::Entity")]
    ImmunologyWaitingListCardAppointments,
    #[sea_orm(has_many = "super::immunology_waiting_list_card_grades::Entity")]
    ImmunologyWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::immunology_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::ImmunologyWaitingListCardAppointments.def()
    }
}

impl Related<super::immunology_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::ImmunologyWaitingListCardGrades.def()
    }
}
