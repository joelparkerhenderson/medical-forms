# Coagulation Test Result — specification
...
- `bin/test-form coagulation-test-result` exits cleanly.
...
- `bin/lily-html-refactor --check coagulation-test-result` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `coagulation-test-result.front-end-with-html.v1` (HTML)
  - `coagulation-test-result.front-end-with-svelte.v1` (SvelteKit)
