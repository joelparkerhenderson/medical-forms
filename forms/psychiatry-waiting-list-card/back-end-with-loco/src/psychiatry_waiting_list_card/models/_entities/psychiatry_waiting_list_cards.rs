...
#[sea_orm(table_name = "psychiatry_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::psychiatry_waiting_list_card_appointments::Entity")]
    PsychiatryWaitingListCardAppointments,
    #[sea_orm(has_many = "super::psychiatry_waiting_list_card_grades::Entity")]
    PsychiatryWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::psychiatry_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::PsychiatryWaitingListCardAppointments.def()
    }
}

impl Related<super::psychiatry_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::PsychiatryWaitingListCardGrades.def()
    }
}
