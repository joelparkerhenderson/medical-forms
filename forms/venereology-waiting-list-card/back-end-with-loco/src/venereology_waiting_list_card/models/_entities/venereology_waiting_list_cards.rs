...
#[sea_orm(table_name = "venereology_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::venereology_waiting_list_card_appointments::Entity")]
    VenereologyWaitingListCardAppointments,
    #[sea_orm(has_many = "super::venereology_waiting_list_card_grades::Entity")]
    VenereologyWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::venereology_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::VenereologyWaitingListCardAppointments.def()
    }
}

impl Related<super::venereology_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::VenereologyWaitingListCardGrades.def()
    }
}
