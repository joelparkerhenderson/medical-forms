...
Generate Loco (loco.rs) scaffolding for the `organ-donation-assessment` form.
...
1. Create a new Loco project (one-time):
   ...
   ```sh
   loco new --name organ-donation-assessment --db postgres --bg async --assets serverside
   ```
