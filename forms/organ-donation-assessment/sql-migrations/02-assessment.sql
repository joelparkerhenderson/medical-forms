-- 02_assessment.sql
-- Top-level organ donation assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Organ donation assessment using donor risk index and organ-specific suitability scoring. Parent entity for all assessment sections.';
