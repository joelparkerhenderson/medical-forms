...
-- Additional safety-critical flags detected during organ donation assessment grading.
...
COMMENT ON TABLE grading_additional_flag IS
    'Additional safety-critical flags detected during organ donation assessment grading (e.g. HIV positive, active malignancy, consent issues).';
...
COMMENT ON COLUMN grading_additional_flag.flag_id IS
    'Identifier of the flag (e.g. FLAG-HIV-001, FLAG-MALIG-001).';
COMMENT ON COLUMN grading_additional_flag.category IS
    'Category of the flag (e.g. Infectious Disease, Malignancy, Consent).';
