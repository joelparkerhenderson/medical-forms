...
-- Individual organ donation assessment rules that fired during grading.
...
COMMENT ON TABLE grading_fired_rule IS
    'Individual organ donation rules that evaluated to true during grading.';
...
COMMENT ON COLUMN grading_fired_rule.rule_id IS
    'Identifier of the rule that fired (e.g. OF-001, ID-002, IM-003).';
COMMENT ON COLUMN grading_fired_rule.category IS
    'Category of the rule (e.g. Organ Function, Infectious Disease, Immunological).';
