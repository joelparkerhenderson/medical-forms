...
-- Demographics section of the organ donation assessment.
...
COMMENT ON TABLE assessment_demographics IS
    'Demographics section: identity, language, blood group, GP, and referrer details. One-to-one child of assessment.';
...
COMMENT ON COLUMN assessment_demographics.blood_group IS
    'ABO and Rh blood group: A+, A-, B+, B-, AB+, AB-, O+, O-, or empty string if unanswered.';
