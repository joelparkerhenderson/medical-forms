...
use crate::models::_entities::biopsy_test_request_grades::{ActiveModel, Entity, Model};
...
pub fn routes() -> Routes {
    Routes::new()
        .prefix("api/biopsy_test_request_grades/")
        .add("/", get(list))
        .add("/", post(add))
        .add("{id}", get(get_one))
