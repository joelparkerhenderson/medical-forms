...
use crate::models::_entities::news2_results::{ActiveModel, Entity, Model};
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.clinical_response = Set(self.clinical_response.clone());
      item.has_any_single_score_3 = Set(self.has_any_single_score_3);
