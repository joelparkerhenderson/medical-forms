-- ============================================================
-- 20_news2_result.sql
-- NEWS2 scoring result (1:1 with casualty_card).
-- ============================================================
-- Stores the computed National Early Warning Score 2 (NEWS2)
-- result. Created when vital signs are recorded and the
-- scoring engine runs. Includes denormalized parameter
-- scores in a JSONB column for audit and display.
-- ============================================================
...
CREATE TRIGGER trg_news2_result_updated_at
