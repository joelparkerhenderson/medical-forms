...
#[sea_orm(table_name = "resp_med_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::resp_med_waiting_list_card_appointments::Entity")]
    RespMedWaitingListCardAppointments,
    #[sea_orm(has_many = "super::resp_med_waiting_list_card_grades::Entity")]
    RespMedWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::resp_med_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::RespMedWaitingListCardAppointments.def()
    }
}

impl Related<super::resp_med_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::RespMedWaitingListCardGrades.def()
    }
}
