...
Generate Loco (loco.rs) scaffolding for the `who-emergency-first-aid-form` form.
...
1. Create a new Loco project (one-time):
   ...
   ```sh
   loco new --name who-emergency-first-aid-form --db postgres --bg async --assets serverside
   ```
