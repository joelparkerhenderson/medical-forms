...
use crate::models::_entities::ultrasound_test_request_grades::{ActiveModel, Entity, Model};

#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct Params {
    pub deleted_at: Option<DateTimeWithTimeZone>,
    pub ultrasound_test_request_id: i64,
    pub appropriateness_score: Option<i32>,
    pub appropriateness_band: String,
    pub suitability_band: String,
    pub prep_requirements: String,
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.ultrasound_test_request_id = Set(self.ultrasound_test_request_id);
      ...
      item.prep_requirements = Set(self.prep_requirements.clone());
...
pub fn routes() -> Routes {
    Routes::new()
        .prefix("api/ultrasound_test_request_grades/")
        .add("/", get(list))
        .add("/", post(add))
        .add("{id}", get(get_one))
