-- 02_assessment.sql
-- Top-level sleep quality assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Sleep quality assessment form using PSQI scoring. Parent entity for all assessment sections.';
