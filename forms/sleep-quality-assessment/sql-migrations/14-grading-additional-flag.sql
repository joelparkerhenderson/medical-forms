...
-- Additional safety-critical flags detected during sleep quality grading.
...
COMMENT ON TABLE grading_additional_flag IS
    'Additional safety-critical flags detected during sleep quality assessment grading.';
...
COMMENT ON COLUMN grading_additional_flag.flag_id IS
    'Identifier of the flag (e.g. FLAG-APNOEA-001, FLAG-DROWSY-001, FLAG-DEP-001).';
COMMENT ON COLUMN grading_additional_flag.category IS
    'Category of the flag (e.g. Sleep Apnoea, Drowsy Driving, Depression, Medication).';
