...
use crate::models::_entities::practitioners::{ActiveModel, Entity, Model};
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.practice_code = Set(self.practice_code.clone());
      item.practitioner_code = Set(self.practitioner_code.clone());
