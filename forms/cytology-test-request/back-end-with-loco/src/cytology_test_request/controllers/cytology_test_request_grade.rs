...
use crate::models::_entities::cytology_test_request_grades::{ActiveModel, Entity, Model};
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.cytology_test_request_id = Set(self.cytology_test_request_id);
...
pub fn routes() -> Routes {
    Routes::new()
        .prefix("api/cytology_test_request_grades/")
        .add("/", get(list))
        .add("/", post(add))
        .add("{id}", get(get_one))
