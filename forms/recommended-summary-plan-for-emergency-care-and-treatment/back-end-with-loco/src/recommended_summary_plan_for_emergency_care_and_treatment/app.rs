...
impl Hooks for App {
    ...
    fn routes(_ctx: &AppContext) -> AppRoutes {
        AppRoutes::with_default_routes() // controller routes below
            ...
            .add_route(controllers::respect_grade_flag::routes())
            .add_route(controllers::respect_grade_rule::routes())
            .add_route(controllers::respect_grade::routes())
            .add_route(controllers::respect::routes())
