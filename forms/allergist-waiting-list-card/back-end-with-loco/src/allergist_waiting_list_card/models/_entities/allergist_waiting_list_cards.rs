...
#[sea_orm(table_name = "allergist_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::allergist_waiting_list_card_appointments::Entity")]
    AllergistWaitingListCardAppointments,
    #[sea_orm(has_many = "super::allergist_waiting_list_card_grades::Entity")]
    AllergistWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::allergist_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::AllergistWaitingListCardAppointments.def()
    }
}

impl Related<super::allergist_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::AllergistWaitingListCardGrades.def()
    }
}
