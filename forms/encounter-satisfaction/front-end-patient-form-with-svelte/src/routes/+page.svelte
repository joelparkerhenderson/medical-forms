...
<div class="flex min-h-screen items-center justify-center bg-gray-50 px-4">
	<div class="w-full max-w-lg text-center">
		<div class="mb-8">
			...
			<h1 class="text-3xl font-bold text-gray-900">Encounter Satisfaction Survey</h1>
			<p class="mt-3 text-gray-600">
				Help us improve your healthcare experience. This survey collects your feedback
				on a recent visit, including scheduling, communication, staff interactions, care quality,
				and the facility environment.
			</p>
		</div>
		...
		<div class="rounded-xl border border-gray-200 bg-white p-6 text-left shadow-sm">
			...
			<ul class="space-y-2 text-sm text-gray-600">
				<li class="flex items-start gap-2">
					...
					8 sections covering your visit experience
				</li>
				<li class="flex items-start gap-2">
					<span class="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary"></span>
				...
				<li class="flex items-start gap-2">
					<span class="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary"></span>
					A satisfaction report will be generated with a downloadable PDF
				</li>
			</ul>
		</div>
		...
		<p class="mt-4 text-xs text-gray-400">
			Your responses are confidential and will be used to improve the quality of care.
		</p>
	</div>
</div>
