...
function _layout($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="min-h-screen bg-gray-50"><header class="border-b border-gray-200 bg-white shadow-sm no-print"><div class="mx-auto max-w-3xl px-4 py-4"><h1 class="text-lg font-bold text-gray-900">Encounter Satisfaction Survey</h1></div></header> <main class="mx-auto max-w-3xl px-4 py-6">`);
    ProgressBar($$renderer2, { currentStep: assessment.currentStep, steps: visibleSteps() });
    $$renderer2.push(`<!----> `);
    children($$renderer2);
