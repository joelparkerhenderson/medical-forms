<script lang="ts">
	...
	function init(api: any) {
		gridApi = api;
		api.exec('sort-rows', { key: 'visitDate', order: 'desc' });
	}
...
<div class="min-h-screen bg-gray-50">
	...
	<header class="bg-nhs-blue text-white shadow">
		<div class="mx-auto max-w-7xl px-4 py-4 sm:px-6">
			<h1 class="text-2xl font-bold">Encounter Satisfaction — Clinician Dashboard</h1>
			<p class="mt-1 text-sm text-blue-100">Patient satisfaction scores with domain breakdown and flagged issues</p>
		</div>
	</header>
			...
			<div class="flex flex-wrap items-end gap-4">
				...
				<div class="min-w-[240px] flex-1">
					...
					<input
						id="search"
						type="text"
						placeholder="Patient name, provider, or department..."
