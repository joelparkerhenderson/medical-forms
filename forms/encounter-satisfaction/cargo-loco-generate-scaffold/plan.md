...
Generate Loco (loco.rs) scaffolding for the `encounter-satisfaction` form.
...
1. Create a new Loco project (one-time):
   ...
   ```sh
   loco new --name encounter-satisfaction --db postgres --bg async --assets serverside
   ```
