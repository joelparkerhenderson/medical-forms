-- ============================================================
-- 10_satisfaction_result.sql
-- ESS scoring result (1:1 with encounter_satisfaction).
-- ============================================================
-- Stores the computed Encounter Satisfaction Score (ESS) result.
-- Created when the scoring engine runs. Includes denormalized
-- domain scores in a JSONB column for audit and display.
-- ============================================================
...
CREATE TRIGGER trg_satisfaction_result_updated_at
