...
Generate Loco (loco.rs) scaffolding for the `blood-donation-assessment` form.
...
1. Create a new Loco project (one-time):
   ...
   ```sh
   loco new --name blood-donation-assessment --db postgres --bg async --assets serverside
   ```
