...
Generate Loco (loco.rs) scaffolding for the `sundowner-syndrome-assessment` form.
...
1. Create a new Loco project (one-time):
   ...
   ```sh
   loco new --name sundowner-syndrome-assessment --db postgres --bg async --assets serverside
   ```
