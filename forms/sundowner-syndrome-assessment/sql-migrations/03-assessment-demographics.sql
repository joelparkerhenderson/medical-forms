...
-- Demographics section of the sundowner syndrome assessment.
...
CREATE TABLE assessment_demographics (
    ...
    living_situation VARCHAR(30) NOT NULL DEFAULT ''
        CHECK (living_situation IN ('own-home', 'family-home', 'residential-care', 'nursing-home', 'hospital', 'other', '')),
    primary_carer_name VARCHAR(255) NOT NULL DEFAULT '',
    primary_carer_relationship VARCHAR(100) NOT NULL DEFAULT '',
...
COMMENT ON TABLE assessment_demographics IS
    'Demographics section: identity, language, living situation, carer, GP, and referrer details. One-to-one child of assessment.';
...
COMMENT ON COLUMN assessment_demographics.living_situation IS
    'Current living situation: own-home, family-home, residential-care, nursing-home, hospital, other, or empty.';
COMMENT ON COLUMN assessment_demographics.primary_carer_name IS
    'Name of the primary carer or next of kin.';
COMMENT ON COLUMN assessment_demographics.primary_carer_relationship IS
    'Relationship of primary carer to patient (e.g. spouse, daughter, son).';
