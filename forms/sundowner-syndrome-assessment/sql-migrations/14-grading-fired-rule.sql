...
-- Individual sundowner syndrome rules that fired during grading.
...
COMMENT ON TABLE grading_fired_rule IS
    'Individual sundowner syndrome rules that evaluated to true during grading.';
...
COMMENT ON COLUMN grading_fired_rule.rule_id IS
    'Identifier of the rule that fired (e.g. BH-001, SL-002, TR-003).';
COMMENT ON COLUMN grading_fired_rule.category IS
    'Category of the rule (e.g. Behavioural, Sleep, Triggers, Environmental, Medication).';
