-- 02_assessment.sql
-- Top-level sundowner syndrome assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Sundowner syndrome assessment form using CMAI and NPI scoring instruments. Parent entity for all assessment sections.';
