...
-- Additional safety-critical flags detected during ergonomic grading.
...
COMMENT ON TABLE grading_additional_flag IS
    'Additional safety-critical flags detected during ergonomic assessment grading (e.g. very high REBA score, HAVS risk, chronic pain indicators).';
...
COMMENT ON COLUMN grading_additional_flag.flag_id IS
    'Identifier of the flag (e.g. FLAG-REBA-001, FLAG-HAVS-001, FLAG-CHRONIC-001).';
COMMENT ON COLUMN grading_additional_flag.category IS
    'Category of the flag (e.g. Posture Risk, Manual Handling, Repetitive Strain, Vibration).';
