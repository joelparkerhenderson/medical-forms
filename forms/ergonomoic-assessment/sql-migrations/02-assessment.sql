-- 02_assessment.sql
-- Top-level ergonomic assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Ergonomic assessment form using REBA scoring. Parent entity for all assessment sections.';
