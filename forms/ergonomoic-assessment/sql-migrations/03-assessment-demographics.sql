...
-- Step 1: Patient demographics section of the ergonomic assessment.
...
COMMENT ON TABLE assessment_demographics IS
    'Step 1 Demographics: patient identifying and employment information. One-to-one child of assessment.';
...
COMMENT ON COLUMN assessment_demographics.occupation IS
    'Patient current job title or role.';
COMMENT ON COLUMN assessment_demographics.employer IS
    'Patient employer or organisation name.';
