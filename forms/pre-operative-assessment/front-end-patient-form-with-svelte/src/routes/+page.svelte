...
<div class="flex min-h-screen items-center justify-center bg-gray-50 px-4">
	<div class="w-full max-w-lg text-center">
		<div class="mb-8">
			...
			<h1 class="text-3xl font-bold text-gray-900">Pre-Operative Assessment</h1>
			<p class="mt-3 text-gray-600">
				Complete this questionnaire to generate an anaesthetic risk assessment.
				Your responses will be used to calculate an ASA grade and identify any
				issues that need to be highlighted for the anaesthetist.
			</p>
		</div>
		...
		<div class="rounded-xl border border-gray-200 bg-white p-6 text-left shadow-sm">
			...
			<ul class="space-y-2 text-sm text-gray-600">
				<li class="flex items-start gap-2">
					...
					16 sections covering your medical history
				</li>
				<li class="flex items-start gap-2">
					<span class="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary"></span>
		...
		<p class="mt-4 text-xs text-gray-400">
			This tool is for clinical support only. All assessments must be reviewed by a qualified anaesthetist.
		</p>
	</div>
</div>
