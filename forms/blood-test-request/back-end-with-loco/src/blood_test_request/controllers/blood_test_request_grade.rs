...
use crate::models::_entities::blood_test_request_grades::{ActiveModel, Entity, Model};

#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct Params {
    pub deleted_at: Option<DateTimeWithTimeZone>,
    pub blood_test_request_id: i64,
    pub appropriateness_score: Option<i32>,
    pub appropriateness_band: String,
    pub preanalytical_band: String,
    pub fasting_violation: bool,
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.blood_test_request_id = Set(self.blood_test_request_id);
      ...
      item.fasting_violation = Set(self.fasting_violation);
...
pub fn routes() -> Routes {
    Routes::new()
        .prefix("api/blood_test_request_grades/")
        .add("/", get(list))
        .add("/", post(add))
        .add("{id}", get(get_one))
