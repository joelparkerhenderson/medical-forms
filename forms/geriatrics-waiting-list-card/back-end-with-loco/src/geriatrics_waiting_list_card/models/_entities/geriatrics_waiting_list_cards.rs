...
#[sea_orm(table_name = "geriatrics_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::geriatrics_waiting_list_card_appointments::Entity")]
    GeriatricsWaitingListCardAppointments,
    #[sea_orm(has_many = "super::geriatrics_waiting_list_card_grades::Entity")]
    GeriatricsWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::geriatrics_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::GeriatricsWaitingListCardAppointments.def()
    }
}

impl Related<super::geriatrics_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::GeriatricsWaitingListCardGrades.def()
    }
}
