...
use crate::models::_entities::cha2ds2_vascs::{ActiveModel, Entity, Model};
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.atrial_fibrillation_type = Set(self.atrial_fibrillation_type.clone());
      ...
      item.stroke_tia_thromboembolism = Set(self.stroke_tia_thromboembolism.clone());
      item.vascular_disease = Set(self.vascular_disease.clone());
