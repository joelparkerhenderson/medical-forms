-- 14_grading_additional_flag.sql
-- Additional safety-critical flags detected during respirology assessment grading.
...
COMMENT ON TABLE grading_additional_flag IS
    'Additional safety-critical flags detected during respirology assessment grading (e.g. haemoptysis, respiratory failure, suspected malignancy).';
...
COMMENT ON COLUMN grading_additional_flag.flag_id IS
    'Identifier of the flag (e.g. FLAG-HAEMOPTYSIS-001, FLAG-DESAT-001, FLAG-OSA-001).';
COMMENT ON COLUMN grading_additional_flag.category IS
    'Category of the flag (e.g. Dyspnoea, Cough, Pulmonary Function, Sleep, Exposure).';
