-- 02_assessment.sql
-- Top-level respirology assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Respirology assessment form. Parent entity for all sections covering the MRC (Medical Research Council) Dyspnoea Scale evaluation.';
