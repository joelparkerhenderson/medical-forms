...
#[sea_orm(table_name = "clin_neurophys_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::clin_neurophys_waiting_list_card_appointments::Entity")]
    ClinNeurophysWaitingListCardAppointments,
    #[sea_orm(has_many = "super::clin_neurophys_waiting_list_card_grades::Entity")]
    ClinNeurophysWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::clin_neurophys_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::ClinNeurophysWaitingListCardAppointments.def()
    }
}

impl Related<super::clin_neurophys_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::ClinNeurophysWaitingListCardGrades.def()
    }
}
