...
#[sea_orm(table_name = "clin_chem_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::clin_chem_waiting_list_card_appointments::Entity")]
    ClinChemWaitingListCardAppointments,
    #[sea_orm(has_many = "super::clin_chem_waiting_list_card_grades::Entity")]
    ClinChemWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::clin_chem_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::ClinChemWaitingListCardAppointments.def()
    }
}

impl Related<super::clin_chem_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::ClinChemWaitingListCardGrades.def()
    }
}
