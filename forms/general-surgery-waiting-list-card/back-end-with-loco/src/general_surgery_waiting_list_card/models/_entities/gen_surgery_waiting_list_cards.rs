...
#[sea_orm(table_name = "gen_surgery_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::gen_surgery_waiting_list_card_appointments::Entity")]
    GenSurgeryWaitingListCardAppointments,
    #[sea_orm(has_many = "super::gen_surgery_waiting_list_card_grades::Entity")]
    GenSurgeryWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::gen_surgery_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::GenSurgeryWaitingListCardAppointments.def()
    }
}

impl Related<super::gen_surgery_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::GenSurgeryWaitingListCardGrades.def()
    }
}
