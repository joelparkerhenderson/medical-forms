...
-- Additional safety-critical flags detected during mental health assessment grading.
...
COMMENT ON TABLE grading_additional_flag IS
    'Additional safety-critical flags detected during mental health assessment grading (e.g. suicidal ideation, self-harm, high PHQ-9 Q9 score).';
...
COMMENT ON COLUMN grading_additional_flag.flag_id IS
    'Identifier of the flag (e.g. FLAG-SUICIDE-001, FLAG-SELF-HARM-001, FLAG-RISK-001).';
COMMENT ON COLUMN grading_additional_flag.category IS
    'Category of the flag (e.g. Suicidal Ideation, Self-Harm, Risk, Substance Use).';
