-- 02_assessment.sql
-- Top-level mental health assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Mental health assessment form using PHQ-9 and GAD-7 instruments. Parent entity for all assessment sections.';
