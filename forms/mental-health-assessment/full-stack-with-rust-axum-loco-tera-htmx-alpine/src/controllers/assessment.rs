...
use crate::engine::{mental_health_grader, flagged_issues, types::AssessmentData};
use crate::models::{
...
fn section_to_json(section: &str) -> &str {
    match section {
        ...
        "anxiety_screening" => "anxietyScreening",
        "risk_assessment" => "riskAssessment",
        "substance_use" => "substanceUse",
        "social_functional_status" => "socialFunctionalStatus",
...
async fn show_report(
    ...
    let (severity_level, severity_score, fired_rules) =
        mental_health_grader::calculate_severity(&assessment_data);
    ...
    context.insert("phq9_total", &phq9);
    context.insert("gad7_total", &gad7);
