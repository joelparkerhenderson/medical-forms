...
use crate::models::_entities::sleep_study_test_request_grades::{ActiveModel, Entity, Model};
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.sleep_study_test_request_id = Set(self.sleep_study_test_request_id);
...
pub fn routes() -> Routes {
    Routes::new()
        .prefix("api/sleep_study_test_request_grades/")
        .add("/", get(list))
        .add("/", post(add))
        .add("{id}", get(get_one))
