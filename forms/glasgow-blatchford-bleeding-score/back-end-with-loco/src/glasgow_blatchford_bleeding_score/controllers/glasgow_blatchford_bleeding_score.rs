...
use crate::models::_entities::glasgow_blatchford_bleeding_scores::{ActiveModel, Entity, Model};
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.blood_urea_mmol_l = Set(self.blood_urea_mmol_l);
      item.haemoglobin_g_l = Set(self.haemoglobin_g_l);
      item.systolic_blood_pressure_mmhg = Set(self.systolic_blood_pressure_mmhg);
      item.pulse_beats_per_min = Set(self.pulse_beats_per_min);
      item.melaena_present = Set(self.melaena_present.clone());
      item.syncope = Set(self.syncope.clone());
      item.hepatic_disease = Set(self.hepatic_disease.clone());
      item.cardiac_failure = Set(self.cardiac_failure.clone());
...
pub fn routes() -> Routes {
    Routes::new()
        .prefix("api/glasgow_blatchford_bleeding_scores/")
        .add("/", get(list))
        .add("/", post(add))
        .add("{id}", get(get_one))
