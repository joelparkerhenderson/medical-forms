...
Generate Loco (loco.rs) scaffolding for the `workplace-climate-assessment` form.
...
1. Create a new Loco project (one-time):
   ...
   ```sh
   loco new --name workplace-climate-assessment --db postgres --bg async --assets serverside
   ```
