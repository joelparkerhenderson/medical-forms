...
#[sea_orm(table_name = "gastro_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::gastro_waiting_list_card_appointments::Entity")]
    GastroWaitingListCardAppointments,
    #[sea_orm(has_many = "super::gastro_waiting_list_card_grades::Entity")]
    GastroWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::gastro_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::GastroWaitingListCardAppointments.def()
    }
}

impl Related<super::gastro_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::GastroWaitingListCardGrades.def()
    }
}
