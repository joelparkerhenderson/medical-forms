...
#[sea_orm(table_name = "infect_dis_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::infect_dis_waiting_list_card_appointments::Entity")]
    InfectDisWaitingListCardAppointments,
    #[sea_orm(has_many = "super::infect_dis_waiting_list_card_grades::Entity")]
    InfectDisWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::infect_dis_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::InfectDisWaitingListCardAppointments.def()
    }
}

impl Related<super::infect_dis_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::InfectDisWaitingListCardGrades.def()
    }
}
