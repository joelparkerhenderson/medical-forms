# Microbiology Culture Test Result — specification
...
- `bin/test-form microbiology-culture-test-result` exits cleanly.
...
- `bin/lily-html-refactor --check microbiology-culture-test-result` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `microbiology-culture-test-result.front-end-with-html.v1` (HTML)
  - `microbiology-culture-test-result.front-end-with-svelte.v1` (SvelteKit)
