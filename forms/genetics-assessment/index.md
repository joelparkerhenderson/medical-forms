...
| #   | Step                                                           |
| --- | -------------------------------------------------------------- |
| 1   | Proband Demographics                                           |
| 2   | Presenting Concern                                             |
| 3   | Personal Medical History (cancers, congenital anomalies, NDD)  |
| 4   | Three-Generation Family Pedigree                               |
| 5   | Consanguinity & Ancestry                                       |
| 6   | Targeted Risk Scoring (Manchester, Bethesda, etc.)             |
| 7   | Prior Genetic Testing                                          |
| 8   | Patient Understanding & Concerns                               |
| 9   | Recommendation & Referral Plan                                 |
