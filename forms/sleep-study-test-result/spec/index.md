# Sleep Study Test Result — specification
...
- `bin/test-form sleep-study-test-result` exits cleanly.
...
- `bin/lily-html-refactor --check sleep-study-test-result` reports no drift.
- LocalStorage keys preserve draft state across reloads:
  - `sleep-study-test-result.front-end-with-html.v1` (HTML)
  - `sleep-study-test-result.front-end-with-svelte.v1` (SvelteKit)
