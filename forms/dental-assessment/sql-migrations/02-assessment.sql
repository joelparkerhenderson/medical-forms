-- 02_assessment.sql
-- Top-level dental assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Dental assessment form using DMFT Index. Parent entity for all assessment sections.';
