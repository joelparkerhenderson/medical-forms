...
use crate::models::_entities::medication_reconciliations::{ActiveModel, Entity, Model};
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.reconciliation_type = Set(self.reconciliation_type.clone());
      item.care_setting = Set(self.care_setting.clone());
      item.reconciled_at = Set(self.reconciled_at);
...
pub fn routes() -> Routes {
    Routes::new()
        .prefix("api/medication_reconciliations/")
        .add("/", get(list))
        .add("/", post(add))
        .add("{id}", get(get_one))
