...
use crate::models::_entities::medication_reconciliation_allergies::{ActiveModel, Entity, Model};
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.substance = Set(self.substance.clone());
...
pub fn routes() -> Routes {
    Routes::new()
        .prefix("api/medication_reconciliation_allergies/")
        .add("/", get(list))
        .add("/", post(add))
        .add("{id}", get(get_one))
