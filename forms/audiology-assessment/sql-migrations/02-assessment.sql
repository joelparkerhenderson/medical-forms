-- 02_assessment.sql
-- Top-level audiology assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Audiology assessment form for comprehensive hearing evaluation. Parent entity for all assessment sections.';
