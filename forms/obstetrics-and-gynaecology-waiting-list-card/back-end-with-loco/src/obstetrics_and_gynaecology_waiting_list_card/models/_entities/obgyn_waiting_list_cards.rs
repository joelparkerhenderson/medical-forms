...
#[sea_orm(table_name = "obgyn_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::obgyn_waiting_list_card_appointments::Entity")]
    ObgynWaitingListCardAppointments,
    #[sea_orm(has_many = "super::obgyn_waiting_list_card_grades::Entity")]
    ObgynWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::obgyn_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::ObgynWaitingListCardAppointments.def()
    }
}

impl Related<super::obgyn_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::ObgynWaitingListCardGrades.def()
    }
}
