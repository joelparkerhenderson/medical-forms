...
use crate::models::_entities::cholesterols::{ActiveModel, Entity, Model};
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.total_hdl_ratio = Set(self.total_hdl_ratio);
      item.on_statin = Set(self.on_statin.clone());
      }
}
