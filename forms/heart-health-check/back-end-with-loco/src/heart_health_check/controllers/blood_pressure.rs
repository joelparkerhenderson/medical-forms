...
use crate::models::_entities::blood_pressures::{ActiveModel, Entity, Model};
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.systolic_bp_sd = Set(self.systolic_bp_sd);
      item.diastolic_bp = Set(self.diastolic_bp);
      item.on_bp_treatment = Set(self.on_bp_treatment.clone());
      item.number_of_bp_medications = Set(self.number_of_bp_medications);
      }
}
