...
use crate::models::_entities::smoking_alcohols::{ActiveModel, Entity, Model};
...
pub struct Params {
    ...
    pub years_since_quit: Option<i32>,
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.years_since_quit = Set(self.years_since_quit);
      item.alcohol_units_per_week = Set(self.alcohol_units_per_week);
      item.alcohol_frequency = Set(self.alcohol_frequency.clone());
      }
}
