import { calculateBMI, calculateTcHdlRatio, isSmoker } from './utils.js';

/**
 * Risk rules for the Heart Health Check assessment.
 * Each rule evaluates the data and fires when its condition is met.
 */
const allRules = [
  // ─── HIGH RISK ─────────────────────────────────────────
  {
...
/**
 * Evaluate all risk rules against the assessment data.
 * Returns an array of fired rules.
 */
export function evaluateRules(data, tenYearRisk, heartAge) {
  const fired = [];
