...
impl Hooks for App {
    ...
    fn routes(_ctx: &AppContext) -> AppRoutes {
        AppRoutes::with_default_routes() // controller routes below
            ...
            .add_route(controllers::health_screening_questionnaire_grade_flag::routes())
            .add_route(controllers::health_screening_questionnaire_grade::routes())
            .add_route(controllers::health_screening_questionnaire::routes())
            .add_route(controllers::assessor::routes())
    ...
    async fn seed(ctx: &AppContext, _base: &Path) -> Result<()> {
        ...
        db::seed::<users::ActiveModel>(
            &ctx.db,
            &format!(
                "{}/src/health_screening_questionnaire/fixtures/users.yaml",
