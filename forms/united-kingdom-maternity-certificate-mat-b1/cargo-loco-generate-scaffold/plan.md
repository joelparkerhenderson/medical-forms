...
Generate Loco (loco.rs) scaffolding for the `united-kingdom-maternity-certificate-mat-b1` form.
...
1. Create a new Loco project (one-time):
   ...
   ```sh
   loco new --name united-kingdom-maternity-certificate-mat-b1 --db postgres --bg async --assets serverside
   ```
