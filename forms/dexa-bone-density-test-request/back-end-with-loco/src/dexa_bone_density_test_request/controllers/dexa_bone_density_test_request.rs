...
use crate::models::_entities::dexa_bone_density_test_requests::{ActiveModel, Entity, Model};
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.previous_fragility_fracture = Set(self.previous_fragility_fracture);
      item.long_term_steroids = Set(self.long_term_steroids);
      item.menopause_status = Set(self.menopause_status.clone());
      item.parental_hip_fracture = Set(self.parental_hip_fracture);
      item.weight_kg = Set(self.weight_kg);
      item.previous_dexa = Set(self.previous_dexa.clone());
      item.previous_dexa_date = Set(self.previous_dexa_date);
...
pub fn routes() -> Routes {
    Routes::new()
        .prefix("api/dexa_bone_density_test_requests/")
        .add("/", get(list))
        .add("/", post(add))
        .add("{id}", get(get_one))
