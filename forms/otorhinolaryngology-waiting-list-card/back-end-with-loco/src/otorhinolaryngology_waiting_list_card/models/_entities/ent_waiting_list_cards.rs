...
#[sea_orm(table_name = "ent_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::ent_waiting_list_card_appointments::Entity")]
    EntWaitingListCardAppointments,
    #[sea_orm(has_many = "super::ent_waiting_list_card_grades::Entity")]
...
impl Related<super::ent_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::EntWaitingListCardAppointments.def()
    }
}
