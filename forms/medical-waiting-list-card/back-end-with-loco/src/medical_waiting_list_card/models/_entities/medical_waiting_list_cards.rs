...
#[sea_orm(table_name = "medical_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::medical_waiting_list_card_appointments::Entity")]
    MedicalWaitingListCardAppointments,
    #[sea_orm(has_many = "super::medical_waiting_list_card_grades::Entity")]
    MedicalWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::medical_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::MedicalWaitingListCardAppointments.def()
    }
}

impl Related<super::medical_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::MedicalWaitingListCardGrades.def()
    }
}
