...
Generate Loco (loco.rs) scaffolding for the `consent-to-treatment` form.
...
1. Create a new Loco project (one-time):
   ...
   ```sh
   loco new --name consent-to-treatment --db postgres --bg async --assets serverside
   ```
