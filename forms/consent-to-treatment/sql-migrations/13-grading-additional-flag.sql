...
-- Additional flags detected during consent form validation.
...
COMMENT ON TABLE grading_additional_flag IS
    'Additional flags detected during consent form validation (e.g. capacity concerns, missing signatures, advance directives).';
...
COMMENT ON COLUMN grading_additional_flag.flag_id IS
    'Identifier of the flag (e.g. FLAG-CAPACITY-001, FLAG-SIG-001).';
COMMENT ON COLUMN grading_additional_flag.category IS
    'Category of the flag (e.g. Capacity, Signature, Patient Rights, Anesthesia).';
