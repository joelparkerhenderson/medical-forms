-- 02_assessment.sql
-- Top-level consent to treatment form linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Consent to treatment form with completeness validation. Parent entity for all consent sections.';
COMMENT ON COLUMN assessment.id IS
    'Primary key UUID, auto-generated.';
COMMENT ON COLUMN assessment.patient_id IS
    'Foreign key to the patient who owns this consent form.';
