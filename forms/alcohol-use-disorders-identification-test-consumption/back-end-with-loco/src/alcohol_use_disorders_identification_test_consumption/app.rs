...
impl Hooks for App {
    ...
    fn routes(_ctx: &AppContext) -> AppRoutes {
        AppRoutes::with_default_routes() // controller routes below
            ...
            .add_route(controllers::audit_c_grade_flag::routes())
            .add_route(controllers::audit_c_grade_rule::routes())
            .add_route(controllers::audit_c_grade::routes())
            .add_route(controllers::audit_c::routes())
