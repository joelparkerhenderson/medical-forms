...
#[sea_orm(table_name = "endocrinology_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::endocrinology_waiting_list_card_appointments::Entity")]
    EndocrinologyWaitingListCardAppointments,
    #[sea_orm(has_many = "super::endocrinology_waiting_list_card_grades::Entity")]
    EndocrinologyWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::endocrinology_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::EndocrinologyWaitingListCardAppointments.def()
    }
}

impl Related<super::endocrinology_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::EndocrinologyWaitingListCardGrades.def()
    }
}
