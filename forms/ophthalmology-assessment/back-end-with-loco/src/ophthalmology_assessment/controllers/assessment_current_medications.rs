...
pub struct Params {
    ...
    pub has_ocular_medications: String,
    pub has_systemic_medications: String,
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.has_ocular_medications = Set(self.has_ocular_medications.clone());
      item.has_systemic_medications = Set(self.has_systemic_medications.clone());
      item.medication_allergies = Set(self.medication_allergies.clone());
