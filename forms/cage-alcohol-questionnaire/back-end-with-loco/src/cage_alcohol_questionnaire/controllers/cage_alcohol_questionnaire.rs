...
use crate::models::_entities::cage_alcohol_questionnaires::{ActiveModel, Entity, Model};
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.cut_down = Set(self.cut_down.clone());
      item.annoyed = Set(self.annoyed.clone());
      item.guilty = Set(self.guilty.clone());
      item.eye_opener = Set(self.eye_opener.clone());
...
pub fn routes() -> Routes {
    Routes::new()
        .prefix("api/cage_alcohol_questionnaires/")
        .add("/", get(list))
        .add("/", post(add))
        .add("{id}", get(get_one))
