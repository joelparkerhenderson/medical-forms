...
use crate::models::_entities::anion_gap_calculators::{ActiveModel, Entity, Model};
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.calculated_at = Set(self.calculated_at);
      ...
      item.chloride_mmol_l = Set(self.chloride_mmol_l);
      item.bicarbonate_mmol_l = Set(self.bicarbonate_mmol_l);
      item.albumin_g_l = Set(self.albumin_g_l);
      item.include_potassium = Set(self.include_potassium.clone());
      }
}
...
pub fn routes() -> Routes {
    Routes::new()
        .prefix("api/anion_gap_calculators/")
        .add("/", get(list))
        .add("/", post(add))
        .add("{id}", get(get_one))
