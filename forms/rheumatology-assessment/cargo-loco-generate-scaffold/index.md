# rheumatology-assessment — cargo-loco-generate-scaffold

Generator scripts that produce the Loco (loco.rs) scaffolding for
the `rheumatology-assessment` form's full-stack Rust backend.
...
- `assessment_joint_assessment`
- `assessment_disease_history`
- `assessment_extra_articular_features`
- `assessment_laboratory_results`
- `assessment_current_medications`
- `assessment_allergies`
- `assessment_functional_assessment`
- `assessment_comorbidities_social`
- `grading_result`
- `grading_fired_rule`
