...
#[sea_orm(table_name = "urology_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::urology_waiting_list_card_appointments::Entity")]
    UrologyWaitingListCardAppointments,
    #[sea_orm(has_many = "super::urology_waiting_list_card_grades::Entity")]
    UrologyWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::urology_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::UrologyWaitingListCardAppointments.def()
    }
}

impl Related<super::urology_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::UrologyWaitingListCardGrades.def()
    }
}
