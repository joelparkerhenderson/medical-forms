...
impl Hooks for App {
    ...
    fn routes(_ctx: &AppContext) -> AppRoutes {
        AppRoutes::with_default_routes() // controller routes below
            ...
            .add_route(controllers::perioperative_optimization_grade_flag::routes())
            .add_route(controllers::perioperative_optimization_grade_domain::routes())
            .add_route(controllers::perioperative_optimization_grade::routes())
            .add_route(controllers::perioperative_optimization::routes())
    ...
    async fn seed(ctx: &AppContext, _base: &Path) -> Result<()> {
        ...
        db::seed::<users::ActiveModel>(
            &ctx.db,
            &format!(
                "{}/src/perioperative_optimization/fixtures/users.yaml",
