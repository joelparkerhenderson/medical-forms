...
use crate::models::_entities::cystoscopy_test_request_grades::{ActiveModel, Entity, Model};
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.cystoscopy_test_request_id = Set(self.cystoscopy_test_request_id);
...
pub fn routes() -> Routes {
    Routes::new()
        .prefix("api/cystoscopy_test_request_grades/")
        .add("/", get(list))
        .add("/", post(add))
        .add("{id}", get(get_one))
