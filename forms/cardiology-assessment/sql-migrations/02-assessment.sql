-- 02_assessment.sql
-- Top-level cardiology assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Cardiology assessment form using CCS Angina and NYHA Heart Failure classifications. Parent entity for all assessment sections.';
