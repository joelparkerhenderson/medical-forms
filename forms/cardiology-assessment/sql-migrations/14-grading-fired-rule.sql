...
-- Individual cardiac classification rules that fired during grading.
...
COMMENT ON TABLE grading_fired_rule IS
    'Individual cardiac classification rules that evaluated to true during grading.';
...
COMMENT ON COLUMN grading_fired_rule.rule_id IS
    'Identifier of the rule that fired (e.g. CCS-001, NYHA-002, RF-003).';
COMMENT ON COLUMN grading_fired_rule.category IS
    'Category of the rule (e.g. Angina, Heart Failure, Risk Factors, Arrhythmia).';
