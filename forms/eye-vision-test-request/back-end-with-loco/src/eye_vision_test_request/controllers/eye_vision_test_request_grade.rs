...
use crate::models::_entities::eye_vision_test_request_grades::{ActiveModel, Entity, Model};
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.eye_vision_test_request_id = Set(self.eye_vision_test_request_id);
...
pub fn routes() -> Routes {
    Routes::new()
        .prefix("api/eye_vision_test_request_grades/")
        .add("/", get(list))
        .add("/", post(add))
        .add("{id}", get(get_one))
