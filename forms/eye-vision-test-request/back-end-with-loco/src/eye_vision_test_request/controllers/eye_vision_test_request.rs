...
use crate::models::_entities::eye_vision_test_requests::{ActiveModel, Entity, Model};
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.symptom_reduced_vision = Set(self.symptom_reduced_vision);
      item.symptom_sudden_loss = Set(self.symptom_sudden_loss);
      item.symptom_flashes_floaters = Set(self.symptom_flashes_floaters);
      item.symptom_eye_pain = Set(self.symptom_eye_pain);
      item.symptom_red_eye = Set(self.symptom_red_eye);
      item.diabetes = Set(self.diabetes);
      item.known_glaucoma = Set(self.known_glaucoma);
...
pub fn routes() -> Routes {
    Routes::new()
        .prefix("api/eye_vision_test_requests/")
        .add("/", get(list))
        .add("/", post(add))
        .add("{id}", get(get_one))
