...
impl Hooks for App {
    ...
    fn routes(_ctx: &AppContext) -> AppRoutes {
        AppRoutes::with_default_routes() // controller routes below
            ...
            .add_route(controllers::knee_replacement_surgery_evaluation_grade_flag::routes())
            .add_route(controllers::knee_replacement_surgery_evaluation_grade::routes())
            .add_route(controllers::knee_replacement_surgery_evaluation::routes())
