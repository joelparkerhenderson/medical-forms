...
impl Hooks for App {
    ...
    fn routes(_ctx: &AppContext) -> AppRoutes {
        AppRoutes::with_default_routes() // controller routes below
            ...
            .add_route(controllers::hernia_diagnostic_evaluation_grade_flag::routes())
            .add_route(controllers::hernia_diagnostic_evaluation_grade::routes())
            .add_route(controllers::hernia_diagnostic_evaluation::routes())
    ...
    async fn seed(ctx: &AppContext, _base: &Path) -> Result<()> {
        ...
        db::seed::<users::ActiveModel>(
            &ctx.db,
            &format!(
                "{}/src/hernia_diagnostic_evaluation/fixtures/users.yaml",
