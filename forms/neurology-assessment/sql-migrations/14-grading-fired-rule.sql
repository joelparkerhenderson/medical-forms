...
-- Individual neurology grading rules that fired during assessment scoring.
...
COMMENT ON TABLE grading_fired_rule IS
    'Individual neurology grading rules that evaluated to true during NIHSS scoring.';
...
COMMENT ON COLUMN grading_fired_rule.rule_id IS
    'Identifier of the rule that fired (e.g. NEURO-NIHSS-001, NEURO-SEIZ-002, NEURO-HA-001).';
COMMENT ON COLUMN grading_fired_rule.category IS
    'Category of the rule (e.g. NIHSS, Headache, Seizure, Motor, Cognitive).';
