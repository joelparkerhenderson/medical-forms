...
use crate::models::_entities::corrected_calcium_calculators::{ActiveModel, Entity, Model};
...
pub struct Params {
    ...
    pub age_band: String,
    pub sex: String,
    pub total_calcium_mmol_l: Option<f64>,
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.sample_reference = Set(self.sample_reference.clone());
      item.patient_identifier = Set(self.patient_identifier.clone());
      item.age_band = Set(self.age_band.clone());
      item.sex = Set(self.sex.clone());
      item.total_calcium_mmol_l = Set(self.total_calcium_mmol_l);
...
pub fn routes() -> Routes {
    Routes::new()
        .prefix("api/corrected_calcium_calculators/")
        .add("/", get(list))
        .add("/", post(add))
        .add("{id}", get(get_one))
