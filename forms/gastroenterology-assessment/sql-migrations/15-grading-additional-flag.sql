...
-- Additional safety-critical flags detected during gastroenterology grading.
...
COMMENT ON TABLE grading_additional_flag IS
    'Additional safety-critical flags detected during gastroenterology assessment grading (e.g. GI bleeding, progressive dysphagia, suspected malignancy, liver decompensation).';
...
COMMENT ON COLUMN grading_additional_flag.flag_id IS
    'Identifier of the flag (e.g. FLAG-REDFLAG-001, FLAG-BLEED-001, FLAG-CANCER-001).';
COMMENT ON COLUMN grading_additional_flag.category IS
    'Category of the flag (e.g. Red Flag, GI Bleeding, Malignancy Suspicion, Liver Disease).';
