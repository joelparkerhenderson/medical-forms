...
#[sea_orm(table_name = "ophthalmology_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::ophthalmology_waiting_list_card_appointments::Entity")]
    OphthalmologyWaitingListCardAppointments,
    #[sea_orm(has_many = "super::ophthalmology_waiting_list_card_grades::Entity")]
...
impl Related<super::ophthalmology_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::OphthalmologyWaitingListCardAppointments.def()
    }
}
