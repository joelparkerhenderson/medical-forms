...
-- Personal information section of the advance statement about care.
...
COMMENT ON TABLE assessment_personal_information IS
    'Personal information section: patient identification and contact details. One-to-one child of assessment.';
...
COMMENT ON COLUMN assessment_personal_information.full_name IS
    'Full legal name of the person making the advance statement.';
...
COMMENT ON COLUMN assessment_personal_information.phone IS
