-- 02_assessment.sql
-- Top-level advance statement about care linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Advance statement about care form. Parent entity for all assessment sections recording patient wishes and preferences about future care.';
COMMENT ON COLUMN assessment.id IS
    'Primary key UUID, auto-generated.';
COMMENT ON COLUMN assessment.patient_id IS
    'Foreign key to the patient who owns this advance statement.';
