-- 08_assessment_polypharmacy_review.sql
-- Polypharmacy review section of the gerontology assessment.
...
CREATE TRIGGER trg_assessment_polypharmacy_review_updated_at
...
CREATE TRIGGER trg_assessment_polypharmacy_review_medication_updated_at
