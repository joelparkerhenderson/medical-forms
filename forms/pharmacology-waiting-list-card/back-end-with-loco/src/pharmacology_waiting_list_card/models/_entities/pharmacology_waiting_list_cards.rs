...
#[sea_orm(table_name = "pharmacology_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::pharmacology_waiting_list_card_appointments::Entity")]
    PharmacologyWaitingListCardAppointments,
    #[sea_orm(has_many = "super::pharmacology_waiting_list_card_grades::Entity")]
    PharmacologyWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::pharmacology_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::PharmacologyWaitingListCardAppointments.def()
    }
}

impl Related<super::pharmacology_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::PharmacologyWaitingListCardGrades.def()
    }
}
