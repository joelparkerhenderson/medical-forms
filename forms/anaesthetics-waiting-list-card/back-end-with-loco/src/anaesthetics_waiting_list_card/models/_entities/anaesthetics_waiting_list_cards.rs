...
#[sea_orm(table_name = "anaesthetics_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::anaesthetics_waiting_list_card_appointments::Entity")]
    AnaestheticsWaitingListCardAppointments,
    #[sea_orm(has_many = "super::anaesthetics_waiting_list_card_grades::Entity")]
    AnaestheticsWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::anaesthetics_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::AnaestheticsWaitingListCardAppointments.def()
    }
}

impl Related<super::anaesthetics_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::AnaestheticsWaitingListCardGrades.def()
    }
}
