...
#[sea_orm(table_name = "dermatology_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::dermatology_waiting_list_card_appointments::Entity")]
    DermatologyWaitingListCardAppointments,
    #[sea_orm(has_many = "super::dermatology_waiting_list_card_grades::Entity")]
...
impl Related<super::dermatology_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::DermatologyWaitingListCardAppointments.def()
    }
}
