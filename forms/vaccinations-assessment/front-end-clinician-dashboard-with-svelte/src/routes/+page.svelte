<script lang="ts">
	...
	function applyFilters() {
		...
		const filter = (row: PatientRow) => {
			...
			// Level filter
			if (levelFilter && row.vaccinationLevel !== levelFilter) {
				return false;
			}
...
<div class="min-h-screen bg-gray-50">
	...
	<header class="bg-nhs-blue text-white shadow">
		<div class="mx-auto max-w-7xl px-4 py-4 sm:px-6">
			<h1 class="text-2xl font-bold">Vaccinations Assessment — Clinician Dashboard</h1>
			<p class="mt-1 text-sm text-blue-100">Patient vaccination compliance overview</p>
		</div>
	</header>
