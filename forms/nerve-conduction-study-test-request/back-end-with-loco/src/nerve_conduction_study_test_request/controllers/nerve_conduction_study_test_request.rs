...
use crate::models::_entities::nerve_conduction_study_test_requests::{ActiveModel, Entity, Model};
...
pub struct Params {
    ...
    pub symptom_numbness: bool,
    pub symptom_weakness: bool,
    pub symptom_pain: bool,
    pub symptom_tingling: bool,
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.symptom_numbness = Set(self.symptom_numbness);
      item.symptom_weakness = Set(self.symptom_weakness);
      item.symptom_pain = Set(self.symptom_pain);
      item.symptom_tingling = Set(self.symptom_tingling);
...
pub fn routes() -> Routes {
    Routes::new()
        .prefix("api/nerve_conduction_study_test_requests/")
        .add("/", get(list))
        .add("/", post(add))
        .add("{id}", get(get_one))
