...
Generate Loco (loco.rs) scaffolding for the `who-counter-referral-form` form.
...
1. Create a new Loco project (one-time):
   ...
   ```sh
   loco new --name who-counter-referral-form --db postgres --bg async --assets serverside
   ```
