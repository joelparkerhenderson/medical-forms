...
Generate Loco (loco.rs) scaffolding for the `sports-medicine-assessment` form.
...
1. Create a new Loco project (one-time):
   ...
   ```sh
   loco new --name sports-medicine-assessment --db postgres --bg async --assets serverside
   ```
