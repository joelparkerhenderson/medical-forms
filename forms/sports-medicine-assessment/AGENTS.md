...
- ./front-end-patient-form-with-svelte/ - Athlete / clinician form; SvelteKit + Svelte 5 + Tailwind 4
- ./front-end-clinician-dashboard-with-svelte/ - Sports medicine dashboard; SvelteKit + SVAR DataGrid
