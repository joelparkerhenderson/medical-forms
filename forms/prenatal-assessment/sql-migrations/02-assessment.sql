-- 02_assessment.sql
-- Top-level prenatal assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Prenatal assessment form. Parent entity for all antenatal evaluation sections with risk stratification.';
