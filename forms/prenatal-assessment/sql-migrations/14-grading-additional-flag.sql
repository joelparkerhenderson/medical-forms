...
-- Additional safety-critical flags detected during prenatal assessment grading.
...
COMMENT ON TABLE grading_additional_flag IS
    'Additional safety-critical flags detected during prenatal assessment grading (e.g. preeclampsia risk, domestic abuse, reduced fetal movement).';
...
COMMENT ON COLUMN grading_additional_flag.flag_id IS
    'Identifier of the flag (e.g. FLAG-PREECLAMPSIA-001, FLAG-GDM-001).';
COMMENT ON COLUMN grading_additional_flag.category IS
    'Category of the flag (e.g. Obstetric, Medical, Mental Health, Safeguarding).';
