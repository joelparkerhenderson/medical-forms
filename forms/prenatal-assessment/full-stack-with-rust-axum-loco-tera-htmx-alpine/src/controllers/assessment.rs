...
use crate::engine::{prenatal_grader, flagged_issues, types::AssessmentData};
use crate::models::{
...
fn section_to_json(section: &str) -> &str {
    match section {
        ...
        "antenatal_screening" => "antenatalScreening",
        "physical_examination" => "physicalExamination",
        "blood_tests" => "bloodTests",
        "ultrasound_findings" => "ultrasoundFindings",
        "mental_health_wellbeing" => "mentalHealthWellbeing",
        "birth_planning" => "birthPlanning",
...
fn is_string_field(field: &str) -> bool {
    matches!(
        ...
        "patientName"
            ...
            | "rhesusStatus"
            | "cervicalLength"
            | "combinedScreeningResult"
            | "quadrupleTestResult"
            | "niptResult"
            | "anomalyScanResult"
            | "infectiousDiseaseScreening"
            | "groupBStrep"
            | "sickleCellThalassaemia"
            | "screeningDeclined"
            | "fetalPresentation"
            | "oedema"
            | "proteinuria"
            ...
            | "currentPsychiatricMedication"
            | "socialSupport"
            | "domesticAbuseScreening"
            | "substanceUse"
            | "smokingStatus"
            | "preferredBirthPlace"
            | "birthPreferencesDiscussed"
            | "painReliefPreferences"
            | "breastfeedingIntention"
            | "antenatalClassesAttended"
            | "birthPartnerIdentified"
            | "consentForInterventions"
            | "vbacDiscussion"
            | "referralToConsultant"
...
async fn show_report(
    ...
    let (risk_level, risk_score, fired_rules) =
        prenatal_grader::calculate_risk(&assessment_data);
