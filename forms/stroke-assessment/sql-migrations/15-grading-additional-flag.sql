...
-- Additional safety-critical flags detected during stroke grading.
...
COMMENT ON TABLE grading_additional_flag IS
    'Additional safety-critical flags detected during stroke assessment grading.';
...
COMMENT ON COLUMN grading_additional_flag.flag_id IS
    'Identifier of the flag (e.g. FLAG-LYSE-001, FLAG-LVO-001, FLAG-HAEM-001).';
COMMENT ON COLUMN grading_additional_flag.category IS
    'Category of the flag (e.g. Thrombolysis Eligibility, Large Vessel Occlusion, Haemorrhage Risk, Anticoagulation).';
