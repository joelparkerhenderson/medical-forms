-- 02_assessment.sql
-- Top-level stroke assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Stroke assessment form using NIHSS scoring. Parent entity for all assessment sections.';
