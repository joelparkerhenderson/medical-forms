...
#[sea_orm(table_name = "occ_med_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::occ_med_waiting_list_card_appointments::Entity")]
    OccMedWaitingListCardAppointments,
    #[sea_orm(has_many = "super::occ_med_waiting_list_card_grades::Entity")]
    OccMedWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::occ_med_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::OccMedWaitingListCardAppointments.def()
    }
}

impl Related<super::occ_med_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::OccMedWaitingListCardGrades.def()
    }
}
