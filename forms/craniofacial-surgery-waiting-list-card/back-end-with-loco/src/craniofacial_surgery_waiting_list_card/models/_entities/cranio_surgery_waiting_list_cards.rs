...
#[sea_orm(table_name = "cranio_surgery_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::cranio_surgery_waiting_list_card_appointments::Entity")]
    CranioSurgeryWaitingListCardAppointments,
    #[sea_orm(has_many = "super::cranio_surgery_waiting_list_card_grades::Entity")]
    CranioSurgeryWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::cranio_surgery_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::CranioSurgeryWaitingListCardAppointments.def()
    }
}

impl Related<super::cranio_surgery_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::CranioSurgeryWaitingListCardGrades.def()
    }
}
