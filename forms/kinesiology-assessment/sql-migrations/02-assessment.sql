-- 02_assessment.sql
-- Top-level kinesiology assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Kinesiology assessment form using the Functional Movement Screen (FMS). Parent entity for all assessment sections.';
