<script lang="ts">
	...
	const p = assessment.data.fmsPatterns.rotaryStability;
...
<SectionCard title="Rotary Stability" description="Assesses multi-plane trunk stability during a combined upper and lower extremity motion.">
