...
-- ============================================================
-- Each row records one diabetes rule that fired during grading.
...
CREATE TABLE grading_fired_rule (
    ...
    diabetes_rule_id    TEXT REFERENCES diabetes_rule(id) ON DELETE SET NULL,
...
COMMENT ON COLUMN grading_fired_rule.diabetes_rule_id IS
