...
use crate::engine::{diabetes_grader, flagged_issues, types::AssessmentData};
use crate::models::{
...
async fn show_report(
    ...
    // Run grading engine
    let (control_level, control_score, fired_rules) =
        diabetes_grader::calculate_control(&assessment_data);
    ...
    context.insert("control_score", &control_score);
