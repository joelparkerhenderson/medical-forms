...
<SectionCard title="Demographics" description="Basic personal and employment information">
	...
	<TextInput label="Occupation" name="occupation" bind:value={d.occupation} required />

	<div class="grid grid-cols-1 gap-x-4 sm:grid-cols-2">
		<TextInput label="Employer" name="employer" bind:value={d.employer} />
		<TextInput label="Job Title" name="jobTitle" bind:value={d.jobTitle} required />
	</div>
