...
-- Denormalized record of each REBA rule that fired.
-- ============================================================
-- Preserves the exact rules and scores at the time of grading
-- for clinical audit trail. References both grading_result
-- and reba_rule.
-- ============================================================
