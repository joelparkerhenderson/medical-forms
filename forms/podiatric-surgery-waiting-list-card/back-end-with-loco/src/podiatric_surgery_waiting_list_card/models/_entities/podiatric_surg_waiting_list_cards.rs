...
#[sea_orm(table_name = "podiatric_surg_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::podiatric_surg_waiting_list_card_appointments::Entity")]
    PodiatricSurgWaitingListCardAppointments,
    #[sea_orm(has_many = "super::podiatric_surg_waiting_list_card_grades::Entity")]
    PodiatricSurgWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::podiatric_surg_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::PodiatricSurgWaitingListCardAppointments.def()
    }
}

impl Related<super::podiatric_surg_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::PodiatricSurgWaitingListCardGrades.def()
    }
}
