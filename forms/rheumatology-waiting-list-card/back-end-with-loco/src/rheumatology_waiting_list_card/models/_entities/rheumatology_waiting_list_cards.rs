...
#[sea_orm(table_name = "rheumatology_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::rheumatology_waiting_list_card_appointments::Entity")]
    RheumatologyWaitingListCardAppointments,
    #[sea_orm(has_many = "super::rheumatology_waiting_list_card_grades::Entity")]
...
impl Related<super::rheumatology_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::RheumatologyWaitingListCardAppointments.def()
    }
}
