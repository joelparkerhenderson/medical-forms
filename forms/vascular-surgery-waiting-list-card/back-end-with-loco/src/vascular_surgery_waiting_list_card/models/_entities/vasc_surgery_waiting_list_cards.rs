...
#[sea_orm(table_name = "vasc_surgery_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::vasc_surgery_waiting_list_card_appointments::Entity")]
    VascSurgeryWaitingListCardAppointments,
    #[sea_orm(has_many = "super::vasc_surgery_waiting_list_card_grades::Entity")]
    VascSurgeryWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::vasc_surgery_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::VascSurgeryWaitingListCardAppointments.def()
    }
}

impl Related<super::vasc_surgery_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::VascSurgeryWaitingListCardGrades.def()
    }
}
