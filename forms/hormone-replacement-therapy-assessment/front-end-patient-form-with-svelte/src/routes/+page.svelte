...
<div class="flex min-h-screen items-center justify-center bg-gray-50 px-4">
	<div class="w-full max-w-lg text-center">
		<div class="mb-8">
			...
			<h1 class="text-3xl font-bold text-gray-900">Hormone Replacement Therapy Assessment</h1>
			<p class="mt-3 text-gray-600">
				Complete this questionnaire to assess menopausal symptoms using the Menopause Rating Scale (MRS)
				and evaluate suitability for hormone replacement therapy. Your responses will generate a symptom
				severity score and risk-benefit classification.
			</p>
		</div>
		...
		<div class="rounded-xl border border-gray-200 bg-white p-6 text-left shadow-sm">
			...
			<ul class="space-y-2 text-sm text-gray-600">
				<li class="flex items-start gap-2">
					...
					10 sections covering symptoms, medical history, and preferences
				</li>
				<li class="flex items-start gap-2">
					<span class="mt-1 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-primary"></span>
