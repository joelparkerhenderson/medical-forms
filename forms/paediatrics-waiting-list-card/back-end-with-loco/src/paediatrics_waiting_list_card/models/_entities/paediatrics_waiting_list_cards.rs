...
#[sea_orm(table_name = "paediatrics_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::paediatrics_waiting_list_card_appointments::Entity")]
    PaediatricsWaitingListCardAppointments,
    #[sea_orm(has_many = "super::paediatrics_waiting_list_card_grades::Entity")]
    PaediatricsWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::paediatrics_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::PaediatricsWaitingListCardAppointments.def()
    }
}

impl Related<super::paediatrics_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::PaediatricsWaitingListCardGrades.def()
    }
}
