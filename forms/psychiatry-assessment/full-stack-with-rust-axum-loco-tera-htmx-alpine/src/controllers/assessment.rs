...
fn section_to_json(section: &str) -> &str {
    match section {
        ...
        "social_functional" => "socialFunctional",
...
async fn show_report(
    ...
    let urgency_category = crate::engine::utils::urgency_category(
        assessment_data.clinical_review.treatment_urgency,
    );
    ...
    context.insert("urgency_category", &urgency_category);
    context.insert("urgency_score", &assessment_data.clinical_review.treatment_urgency);
