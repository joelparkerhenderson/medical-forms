...
pub struct Params {
    ...
    pub takes_psychiatric_medications: String,
    pub takes_other_medications: String,
    pub medication_adherence: String,
    pub adherence_barriers: String,
    pub side_effects: String,
    pub clozapine_registered: String,
    pub depot_injection: String,
    pub depot_details: String,
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.takes_psychiatric_medications = Set(self.takes_psychiatric_medications.clone());
      ...
      item.adherence_barriers = Set(self.adherence_barriers.clone());
      item.side_effects = Set(self.side_effects.clone());
      item.clozapine_registered = Set(self.clozapine_registered.clone());
      item.depot_injection = Set(self.depot_injection.clone());
      item.depot_details = Set(self.depot_details.clone());
