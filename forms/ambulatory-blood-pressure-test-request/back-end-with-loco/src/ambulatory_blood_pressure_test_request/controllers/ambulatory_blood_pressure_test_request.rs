...
use crate::models::_entities::ambulatory_blood_pressure_test_requests::{ActiveModel, Entity, Model};
...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.clinic_bp_systolic = Set(self.clinic_bp_systolic);
      item.clinic_bp_diastolic = Set(self.clinic_bp_diastolic);
      item.on_antihypertensives = Set(self.on_antihypertensives);
      item.current_medications = Set(self.current_medications.clone());
      item.symptom_dizziness = Set(self.symptom_dizziness);
      item.symptom_headache = Set(self.symptom_headache);
      item.atrial_fibrillation = Set(self.atrial_fibrillation);
...
pub fn routes() -> Routes {
    Routes::new()
        .prefix("api/ambulatory_blood_pressure_test_requests/")
        .add("/", get(list))
        .add("/", post(add))
        .add("{id}", get(get_one))
