...
#[sea_orm(table_name = "prev_med_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::prev_med_waiting_list_card_appointments::Entity")]
    PrevMedWaitingListCardAppointments,
    #[sea_orm(has_many = "super::prev_med_waiting_list_card_grades::Entity")]
...
impl Related<super::prev_med_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::PrevMedWaitingListCardAppointments.def()
    }
}
