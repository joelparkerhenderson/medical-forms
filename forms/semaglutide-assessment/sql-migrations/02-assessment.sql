-- 02_assessment.sql
-- Top-level semaglutide eligibility assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Semaglutide eligibility assessment form. Parent entity for all assessment sections.';
