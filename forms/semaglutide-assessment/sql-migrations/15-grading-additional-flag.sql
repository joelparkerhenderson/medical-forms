...
-- Additional safety-critical flags detected during semaglutide grading.
...
COMMENT ON TABLE grading_additional_flag IS
    'Additional safety-critical flags detected during semaglutide eligibility grading.';
...
COMMENT ON COLUMN grading_additional_flag.flag_id IS
    'Identifier of the flag (e.g. FLAG-MTC-001, FLAG-PANC-001, FLAG-HYPO-001).';
COMMENT ON COLUMN grading_additional_flag.category IS
    'Category of the flag (e.g. Thyroid Cancer Risk, Pancreatitis, Hypoglycaemia, Mental Health).';
