-- 02_assessment.sql
-- Top-level vaccinations checklist assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Vaccinations checklist assessment form tracking immunisation status. Parent entity for all assessment sections.';
