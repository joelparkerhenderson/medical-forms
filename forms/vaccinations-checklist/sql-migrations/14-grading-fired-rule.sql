...
-- Individual vaccination compliance rules that fired during grading.
...
COMMENT ON TABLE grading_fired_rule IS
    'Individual vaccination compliance rules that evaluated to true during grading.';
...
COMMENT ON COLUMN grading_fired_rule.rule_id IS
    'Identifier of the rule that fired (e.g. VAX-001, OCC-002, TRV-003).';
COMMENT ON COLUMN grading_fired_rule.category IS
    'Category of the rule (e.g. Childhood, Occupational, Travel, COVID, Influenza).';
