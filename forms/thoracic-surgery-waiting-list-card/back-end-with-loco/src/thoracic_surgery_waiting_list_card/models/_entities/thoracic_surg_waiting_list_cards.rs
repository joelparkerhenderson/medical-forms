...
#[sea_orm(table_name = "thoracic_surg_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::thoracic_surg_waiting_list_card_appointments::Entity")]
    ThoracicSurgWaitingListCardAppointments,
    #[sea_orm(has_many = "super::thoracic_surg_waiting_list_card_grades::Entity")]
    ThoracicSurgWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::thoracic_surg_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::ThoracicSurgWaitingListCardAppointments.def()
    }
}

impl Related<super::thoracic_surg_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::ThoracicSurgWaitingListCardGrades.def()
    }
}
