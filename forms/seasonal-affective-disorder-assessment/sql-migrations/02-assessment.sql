-- 02_assessment.sql
-- Top-level seasonal affective disorder assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Seasonal affective disorder assessment form using SPAQ GSS and PHQ-9. Parent entity for all assessment sections.';
