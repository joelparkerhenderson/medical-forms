...
-- Individual SAD assessment rules that fired during grading.
...
COMMENT ON TABLE grading_fired_rule IS
    'Individual SAD assessment rules that evaluated to true during grading.';
...
COMMENT ON COLUMN grading_fired_rule.rule_id IS
    'Identifier of the rule that fired (e.g. GSS-001, PHQ-001, RISK-001).';
COMMENT ON COLUMN grading_fired_rule.category IS
    'Category of the rule (e.g. Seasonality, Depression, Risk, Sleep, Social).';
