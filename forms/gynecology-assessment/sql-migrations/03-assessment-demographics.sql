...
-- Demographics section of the gynaecology assessment.
...
COMMENT ON TABLE assessment_demographics IS
    'Demographics section: ethnicity, language, emergency contact, and GP details. One-to-one child of assessment.';
