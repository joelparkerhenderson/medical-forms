...
use crate::engine::{gynecology_grader, flagged_issues, types::AssessmentData};
use crate::models::{
...
fn section_to_json(section: &str) -> &str {
    match section {
        ...
        "gynecological_symptoms" => "gynecologicalSymptoms",
        "obstetric_history" => "obstetricHistory",
        "cervical_screening" => "cervicalScreening",
        "contraception_fertility" => "contraceptionFertility",
...
async fn show_report(
    ...
    let (severity_level, severity_score, fired_rules) =
        gynecology_grader::calculate_severity(&assessment_data);
