# gynecology-assessment — cargo-loco-generate-scaffold

Generator scripts that produce the Loco (loco.rs) scaffolding for
the `gynecology-assessment` form's full-stack Rust backend.
...
- `assessment_gynecological_symptoms`
- `assessment_cervical_screening`
