...
Generate Loco (loco.rs) scaffolding for the `united-kingdom-driver-and-vehicle-licensing-agency-m1-form` form.
...
1. Create a new Loco project (one-time):
   ...
   ```sh
   loco new --name united-kingdom-driver-and-vehicle-licensing-agency-m1-form --db postgres --bg async --assets serverside
   ```
