...
#[sea_orm(table_name = "neuropsych_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::neuropsych_waiting_list_card_appointments::Entity")]
    NeuropsychWaitingListCardAppointments,
    #[sea_orm(has_many = "super::neuropsych_waiting_list_card_grades::Entity")]
    NeuropsychWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::neuropsych_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::NeuropsychWaitingListCardAppointments.def()
    }
}

impl Related<super::neuropsych_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::NeuropsychWaitingListCardGrades.def()
    }
}
