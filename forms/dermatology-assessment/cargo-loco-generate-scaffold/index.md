# dermatology-assessment — cargo-loco-generate-scaffold

Generator scripts that produce the Loco (loco.rs) scaffolding for
the `dermatology-assessment` form's full-stack Rust backend.
...
- `assessment_dlqi_questionnaire`
- `assessment_lesion_characteristics`
