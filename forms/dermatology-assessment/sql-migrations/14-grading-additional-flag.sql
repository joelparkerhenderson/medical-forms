...
-- Additional safety-critical flags detected during dermatology grading.
...
COMMENT ON TABLE grading_additional_flag IS
    'Additional safety-critical flags detected during dermatology assessment grading (e.g. suspicious lesion, skin cancer risk, severe DLQI impact).';
...
COMMENT ON COLUMN grading_additional_flag.flag_id IS
    'Identifier of the flag (e.g. FLAG-MELANOMA-001, FLAG-DLQI-001).';
COMMENT ON COLUMN grading_additional_flag.category IS
    'Category of the flag (e.g. Skin Cancer Risk, Quality of Life, Lesion Morphology).';
