-- 02_assessment.sql
-- Top-level dermatology assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Dermatology assessment form using DLQI. Parent entity for all assessment sections.';
