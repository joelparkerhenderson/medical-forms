...
#[sea_orm(table_name = "neurosurgery_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::neurosurgery_waiting_list_card_appointments::Entity")]
    NeurosurgeryWaitingListCardAppointments,
    #[sea_orm(has_many = "super::neurosurgery_waiting_list_card_grades::Entity")]
    NeurosurgeryWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::neurosurgery_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::NeurosurgeryWaitingListCardAppointments.def()
    }
}

impl Related<super::neurosurgery_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::NeurosurgeryWaitingListCardGrades.def()
    }
}
