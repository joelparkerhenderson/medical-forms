...
- **Risk levels**:
  - Low: Ideal HLA match, healthy donor, no comorbidities
  - Moderate: Minor health issues, manageable conditions
  - High: Partial match, borderline fitness, significant comorbidities
  - Critical: Contraindicated, serious health risks, donor safety concerns
...
| --- | -------------------------------- |
| 1   | Demographics                     |
| 2   | Donor Registration & HLA Typing  |
| 3   | Medical History                  |
| 4   | Physical Examination             |
| 5   | Haematological Assessment        |
| 6   | Infectious Disease Screening     |
| 7   | Anaesthetic Assessment           |
| 8   | Collection Method Assessment     |
| 9   | Psychological Readiness          |
| 10  | Consent & Eligibility Decision   |
