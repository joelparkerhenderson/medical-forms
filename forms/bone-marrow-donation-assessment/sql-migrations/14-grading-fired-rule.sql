...
-- Individual donor eligibility rules that fired during grading.
...
COMMENT ON TABLE grading_fired_rule IS
    'Individual donor eligibility rules that evaluated to true during grading.';
...
COMMENT ON COLUMN grading_fired_rule.rule_id IS
    'Identifier of the rule that fired (e.g. HLA-001, MH-002, ID-003).';
COMMENT ON COLUMN grading_fired_rule.category IS
    'Category of the rule (e.g. HLA Matching, Medical History, Infectious Disease, Anaesthetic).';
