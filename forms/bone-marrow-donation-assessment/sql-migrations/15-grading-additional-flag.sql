...
-- Additional safety-critical flags detected during bone marrow donation assessment grading.
...
COMMENT ON TABLE grading_additional_flag IS
    'Additional safety-critical flags detected during bone marrow donation assessment grading (e.g. positive infectious disease screen, anaesthetic risk, coercion concern).';
...
COMMENT ON COLUMN grading_additional_flag.flag_id IS
    'Identifier of the flag (e.g. FLAG-HIV-001, FLAG-ASA-001).';
COMMENT ON COLUMN grading_additional_flag.category IS
    'Category of the flag (e.g. Infectious Disease, Anaesthetic, Psychological, HLA).';
