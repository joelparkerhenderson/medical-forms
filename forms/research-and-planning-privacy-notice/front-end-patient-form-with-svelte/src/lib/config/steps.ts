...
export const steps: StepConfig[] = [
	...
	{ number: 2, title: 'Research & Planning Privacy Notice', shortTitle: 'Notice', section: 'researchPlanningPrivacyNotice' },
	{ number: 3, title: 'Opt-Out Preference, Acknowledgement & Signature', shortTitle: 'Acknowledgement', section: 'acknowledgementSignature' }
];
