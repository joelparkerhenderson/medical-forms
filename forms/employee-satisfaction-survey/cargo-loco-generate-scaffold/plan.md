...
Generate Loco (loco.rs) scaffolding for the `employee-satisfaction-survey` form.
...
1. Create a new Loco project (one-time):
   ...
   ```sh
   loco new --name employee-satisfaction-survey --db postgres --bg async --assets serverside
   ```
