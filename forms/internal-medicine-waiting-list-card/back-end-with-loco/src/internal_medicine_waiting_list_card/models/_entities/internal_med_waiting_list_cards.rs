...
#[sea_orm(table_name = "internal_med_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::internal_med_waiting_list_card_appointments::Entity")]
    InternalMedWaitingListCardAppointments,
    #[sea_orm(has_many = "super::internal_med_waiting_list_card_grades::Entity")]
    InternalMedWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::internal_med_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::InternalMedWaitingListCardAppointments.def()
    }
}

impl Related<super::internal_med_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::InternalMedWaitingListCardGrades.def()
    }
}
