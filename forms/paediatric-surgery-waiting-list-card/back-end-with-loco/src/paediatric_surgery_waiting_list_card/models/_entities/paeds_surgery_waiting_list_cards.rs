...
#[sea_orm(table_name = "paeds_surgery_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::paeds_surgery_waiting_list_card_appointments::Entity")]
    PaedsSurgeryWaitingListCardAppointments,
    #[sea_orm(has_many = "super::paeds_surgery_waiting_list_card_grades::Entity")]
    PaedsSurgeryWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::paeds_surgery_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::PaedsSurgeryWaitingListCardAppointments.def()
    }
}

impl Related<super::paeds_surgery_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::PaedsSurgeryWaitingListCardGrades.def()
    }
}
