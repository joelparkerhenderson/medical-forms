-- 02_assessment.sql
-- Top-level attention deficit assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Attention deficit (ADHD) assessment form using the ASRS v1.1 screening instrument. Parent entity for all assessment sections.';
