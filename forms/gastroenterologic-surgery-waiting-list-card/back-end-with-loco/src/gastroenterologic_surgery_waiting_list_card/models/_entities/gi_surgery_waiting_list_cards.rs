...
#[sea_orm(table_name = "gi_surgery_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::gi_surgery_waiting_list_card_appointments::Entity")]
    GiSurgeryWaitingListCardAppointments,
    #[sea_orm(has_many = "super::gi_surgery_waiting_list_card_grades::Entity")]
...
impl Related<super::gi_surgery_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::GiSurgeryWaitingListCardAppointments.def()
    }
}
