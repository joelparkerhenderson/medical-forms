...
#[sea_orm(table_name = "plastic_surg_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::plastic_surg_waiting_list_card_appointments::Entity")]
    PlasticSurgWaitingListCardAppointments,
    #[sea_orm(has_many = "super::plastic_surg_waiting_list_card_grades::Entity")]
    PlasticSurgWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::plastic_surg_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::PlasticSurgWaitingListCardAppointments.def()
    }
}

impl Related<super::plastic_surg_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::PlasticSurgWaitingListCardGrades.def()
    }
}
