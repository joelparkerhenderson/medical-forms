...
#[sea_orm(table_name = "stomatology_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::stomatology_waiting_list_card_appointments::Entity")]
    StomatologyWaitingListCardAppointments,
    #[sea_orm(has_many = "super::stomatology_waiting_list_card_grades::Entity")]
    StomatologyWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::stomatology_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::StomatologyWaitingListCardAppointments.def()
    }
}

impl Related<super::stomatology_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::StomatologyWaitingListCardGrades.def()
    }
}
