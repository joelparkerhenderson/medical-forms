...
Generate Loco (loco.rs) scaffolding for the `employee-offboarding-checklist` form.
...
1. Create a new Loco project (one-time):
   ...
   ```sh
   loco new --name employee-offboarding-checklist --db postgres --bg async --assets serverside
   ```
