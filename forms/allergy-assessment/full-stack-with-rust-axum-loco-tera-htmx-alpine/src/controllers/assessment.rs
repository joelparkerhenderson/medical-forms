...
fn section_to_json(section: &str) -> &str {
    match section {
        ...
        "current_allergies" => "currentAllergies",
        "symptoms_reactions" => "symptomsReactions",
        "environmental_triggers" => "environmentalTriggers",
        "food_drug_allergies" => "foodDrugAllergies",
...
fn is_string_field(field: &str) -> bool {
    matches!(
        ...
        "fullName"
            ...
            | "skinPrickTestResult"
            | "challengeTestDone"
            | "componentResolvedDiagnostics"
            | "antihistamineUse"
            | "nasalCorticosteroid"
            | "immunotherapy"
            | "immunotherapyDuration"
            | "epiPenCarried"
            | "otherMedications"
            | "hasEmergencyPlan"
            | "planReviewDate"
