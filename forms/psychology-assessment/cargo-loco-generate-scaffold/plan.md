...
Generate Loco (loco.rs) scaffolding for the `psychology-assessment` form.
...
1. Create a new Loco project (one-time):
   ...
   ```sh
   loco new --name psychology-assessment --db postgres --bg async --assets serverside
   ```
