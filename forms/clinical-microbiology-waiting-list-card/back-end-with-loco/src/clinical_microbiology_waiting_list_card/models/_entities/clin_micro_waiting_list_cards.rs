...
#[sea_orm(table_name = "clin_micro_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::clin_micro_waiting_list_card_appointments::Entity")]
    ClinMicroWaitingListCardAppointments,
    #[sea_orm(has_many = "super::clin_micro_waiting_list_card_grades::Entity")]
    ClinMicroWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::clin_micro_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::ClinMicroWaitingListCardAppointments.def()
    }
}

impl Related<super::clin_micro_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::ClinMicroWaitingListCardGrades.def()
    }
}
