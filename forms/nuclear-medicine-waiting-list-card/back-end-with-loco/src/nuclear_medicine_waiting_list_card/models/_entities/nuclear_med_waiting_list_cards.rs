...
#[sea_orm(table_name = "nuclear_med_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::nuclear_med_waiting_list_card_appointments::Entity")]
    NuclearMedWaitingListCardAppointments,
    #[sea_orm(has_many = "super::nuclear_med_waiting_list_card_grades::Entity")]
    NuclearMedWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::nuclear_med_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::NuclearMedWaitingListCardAppointments.def()
    }
}

impl Related<super::nuclear_med_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::NuclearMedWaitingListCardGrades.def()
    }
}
