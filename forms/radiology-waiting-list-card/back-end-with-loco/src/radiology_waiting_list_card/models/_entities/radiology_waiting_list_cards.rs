...
#[sea_orm(table_name = "radiology_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::radiology_waiting_list_card_appointments::Entity")]
    RadiologyWaitingListCardAppointments,
    #[sea_orm(has_many = "super::radiology_waiting_list_card_grades::Entity")]
...
impl Related<super::radiology_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::RadiologyWaitingListCardAppointments.def()
    }
}
