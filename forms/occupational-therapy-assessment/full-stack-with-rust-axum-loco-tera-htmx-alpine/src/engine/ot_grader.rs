...
/// Pure function: evaluates all OT rules against assessment data.
/// Returns the function level, composite score (0-100), and fired rules.
/// If fewer than 5 items are answered, returns "draft" status.
pub fn calculate_function_level(data: &AssessmentData) -> (FunctionLevel, f64, Vec<FiredRule>) {
    ...
    // Determine function level from composite score
