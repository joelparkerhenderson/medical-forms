...
-- Individual competency rules that fired during grading.
...
COMMENT ON TABLE grading_fired_rule IS
    'Individual competency rules that evaluated to true during grading.';
...
COMMENT ON COLUMN grading_fired_rule.rule_id IS
    'Identifier of the rule that fired (e.g. PF-001, CS-002, EQ-003).';
COMMENT ON COLUMN grading_fired_rule.category IS
    'Category of the rule (e.g. Physical Fitness, Clinical Skills, Equipment, Communication, Psychological).';
