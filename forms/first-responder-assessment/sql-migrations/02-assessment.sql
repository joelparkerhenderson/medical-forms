-- 02_assessment.sql
-- Top-level first responder assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'First responder assessment form evaluating fitness and competency for paramedics, EMTs, and first aiders. Parent entity for all assessment sections.';
