...
#[sea_orm(table_name = "pmr_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::pmr_waiting_list_card_appointments::Entity")]
    PmrWaitingListCardAppointments,
    #[sea_orm(has_many = "super::pmr_waiting_list_card_grades::Entity")]
...
impl Related<super::pmr_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::PmrWaitingListCardAppointments.def()
    }
}
