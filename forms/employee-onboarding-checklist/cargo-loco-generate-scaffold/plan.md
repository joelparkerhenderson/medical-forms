...
Generate Loco (loco.rs) scaffolding for the `employee-onboarding-checklist` form.
...
1. Create a new Loco project (one-time):
   ...
   ```sh
   loco new --name employee-onboarding-checklist --db postgres --bg async --assets serverside
   ```
