...
-- Individual onboarding compliance rules that fired during grading.
...
COMMENT ON TABLE grading_fired_rule IS
    'Individual onboarding compliance rules that evaluated to true during grading.';
...
COMMENT ON COLUMN grading_fired_rule.rule_id IS
    'Identifier of the rule that fired (e.g. DBS-001, OH-001, TR-001).';
COMMENT ON COLUMN grading_fired_rule.category IS
    'Category of the rule (e.g. Pre-Employment, Training, Registration, IT Access).';
