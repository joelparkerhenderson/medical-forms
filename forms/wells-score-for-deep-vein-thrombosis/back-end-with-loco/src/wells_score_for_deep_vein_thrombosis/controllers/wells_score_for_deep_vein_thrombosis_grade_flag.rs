...
use crate::models::_entities::wells_score_for_deep_vein_thrombosis_grade_flags::{ActiveModel, Entity, Model};
...
pub fn routes() -> Routes {
    Routes::new()
        .prefix("api/wells_score_for_deep_vein_thrombosis_grade_flags/")
        .add("/", get(list))
        .add("/", post(add))
        .add("{id}", get(get_one))
