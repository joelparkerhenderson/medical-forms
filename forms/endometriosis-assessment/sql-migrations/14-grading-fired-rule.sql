...
-- Individual endometriosis assessment rules that fired during grading.
...
COMMENT ON TABLE grading_fired_rule IS
    'Individual endometriosis assessment rules that evaluated to true during grading.';
...
COMMENT ON COLUMN grading_fired_rule.rule_id IS
    'Identifier of the rule that fired (e.g. PAIN-001, GI-002, FERT-003).';
COMMENT ON COLUMN grading_fired_rule.category IS
    'Category of the rule (e.g. Pain, GI Symptoms, Fertility, Surgical).';
