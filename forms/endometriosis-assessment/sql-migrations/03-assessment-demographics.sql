...
-- Demographics section of the endometriosis assessment.
...
CREATE TABLE assessment_demographics (
    ...
    gender_identity VARCHAR(50) NOT NULL DEFAULT ''
        CHECK (gender_identity IN ('female', 'non-binary', 'other', '')),
...
COMMENT ON COLUMN assessment_demographics.gender_identity IS
    'Patient gender identity: female, non-binary, other, or empty string if unanswered.';
