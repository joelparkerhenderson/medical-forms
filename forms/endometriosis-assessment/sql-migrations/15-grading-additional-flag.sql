...
-- Additional safety-critical flags detected during endometriosis assessment grading.
...
COMMENT ON TABLE grading_additional_flag IS
    'Additional safety-critical flags detected during endometriosis assessment grading (e.g. bowel obstruction, urinary obstruction, fertility crisis).';
...
COMMENT ON COLUMN grading_additional_flag.flag_id IS
    'Identifier of the flag (e.g. FLAG-BOWEL-001, FLAG-FERT-001).';
COMMENT ON COLUMN grading_additional_flag.category IS
    'Category of the flag (e.g. Bowel, Urinary, Fertility, Pain).';
