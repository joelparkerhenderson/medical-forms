# endometriosis-assessment — cargo-loco-generate-scaffold

Generator scripts that produce the Loco (loco.rs) scaffolding for
the `endometriosis-assessment` form's full-stack Rust backend.
...
- `assessment_pain_assessment`
- `assessment_gastrointestinal_symptoms`
- `assessment_urinary_symptoms`
- `assessment_fertility`
- `assessment_previous_treatments`
- `assessment_surgical_history`
- `assessment_quality_of_life`
