...
#[sea_orm(table_name = "trop_med_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::trop_med_waiting_list_card_appointments::Entity")]
    TropMedWaitingListCardAppointments,
    #[sea_orm(has_many = "super::trop_med_waiting_list_card_grades::Entity")]
    TropMedWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::trop_med_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::TropMedWaitingListCardAppointments.def()
    }
}

impl Related<super::trop_med_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::TropMedWaitingListCardGrades.def()
    }
}
