...
#[sea_orm(table_name = "family_general_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::family_general_waiting_list_card_appointments::Entity")]
    FamilyGeneralWaitingListCardAppointments,
    #[sea_orm(has_many = "super::family_general_waiting_list_card_grades::Entity")]
    FamilyGeneralWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::family_general_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::FamilyGeneralWaitingListCardAppointments.def()
    }
}

impl Related<super::family_general_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::FamilyGeneralWaitingListCardGrades.def()
    }
}
