...
#[sea_orm(table_name = "nephrology_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::nephrology_waiting_list_card_appointments::Entity")]
    NephrologyWaitingListCardAppointments,
    #[sea_orm(has_many = "super::nephrology_waiting_list_card_grades::Entity")]
    NephrologyWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::nephrology_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::NephrologyWaitingListCardAppointments.def()
    }
}

impl Related<super::nephrology_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::NephrologyWaitingListCardGrades.def()
    }
}
