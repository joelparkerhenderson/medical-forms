...
#[sea_orm(table_name = "hematology_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::hematology_waiting_list_card_appointments::Entity")]
    HematologyWaitingListCardAppointments,
    #[sea_orm(has_many = "super::hematology_waiting_list_card_grades::Entity")]
...
impl Related<super::hematology_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::HematologyWaitingListCardAppointments.def()
    }
}
