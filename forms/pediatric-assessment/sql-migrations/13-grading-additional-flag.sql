-- 13_grading_additional_flag.sql
-- Additional safety-critical flags detected during pediatric assessment grading.
...
COMMENT ON TABLE grading_additional_flag IS
    'Additional safety-critical flags detected during pediatric assessment grading (e.g. safeguarding concerns, missed immunizations, failure to thrive).';
...
COMMENT ON COLUMN grading_additional_flag.flag_id IS
    'Identifier of the flag (e.g. FLAG-SAFEGUARD-001, FLAG-IMMUN-001).';
COMMENT ON COLUMN grading_additional_flag.category IS
    'Category of the flag (e.g. Safeguarding, Immunization, Growth, Development).';
