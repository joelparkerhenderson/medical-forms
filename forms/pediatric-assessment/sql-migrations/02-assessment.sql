-- 02_assessment.sql
-- Top-level pediatric assessment linking a patient to an assessment instance.
...
COMMENT ON TABLE assessment IS
    'Pediatric assessment form. Parent entity for all assessment sections covering child development screening.';
COMMENT ON COLUMN assessment.id IS
    'Primary key UUID, auto-generated.';
COMMENT ON COLUMN assessment.patient_id IS
    'Foreign key to the patient (child) who owns this assessment.';
