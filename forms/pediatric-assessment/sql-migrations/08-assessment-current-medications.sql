...
-- Current medications section of the pediatric assessment.
...
CREATE TABLE assessment_current_medications (
    ...
    over_the_counter_details TEXT NOT NULL DEFAULT '',
...
COMMENT ON COLUMN assessment_current_medications.takes_regular_medications IS
    'Whether the child takes any regular prescribed medications.';
COMMENT ON COLUMN assessment_current_medications.takes_over_the_counter IS
    'Whether the child takes any over-the-counter medications.';
COMMENT ON COLUMN assessment_current_medications.takes_supplements IS
    'Whether the child takes any vitamin or nutritional supplements.';
COMMENT ON COLUMN assessment_current_medications.medication_adherence IS
    'Reported medication adherence: good, fair, poor, or empty.';
COMMENT ON COLUMN assessment_current_medications.adverse_drug_reactions IS
    'Free-text description of any adverse drug reactions experienced.';
