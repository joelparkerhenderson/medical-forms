# pediatric-assessment — cargo-loco-generate-scaffold

Generator scripts that produce the Loco (loco.rs) scaffolding for
the `pediatric-assessment` form's full-stack Rust backend.
...
- `patient`
- `assessment`
- `assessment_birth_history`
- `assessment_growth_nutrition`
- `assessment_developmental_milestones`
- `assessment_immunization_status`
- `assessment_medical_history`
- `assessment_current_medications`
- `assessment_medication_item`
- `assessment_family_history`
- `assessment_social_environmental`
- `grading_result`
- `grading_fired_rule`
