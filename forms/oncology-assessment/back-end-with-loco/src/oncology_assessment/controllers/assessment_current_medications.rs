...
impl Params {
    fn update(&self, item: &mut ActiveModel) {
      ...
      item.polypharmacy_concern = Set(self.polypharmacy_concern.clone());
      ...
      item.complementary_medicines = Set(self.complementary_medicines.clone());
      item.complementary_medicine_details = Set(self.complementary_medicine_details.clone());
