...
pub enum Relation {
    #[sea_orm(has_many = "super::pre_operative_assessment_by_patients::Entity")]
    PreOperativeAssessmentByPatients,
}

impl Related<super::pre_operative_assessment_by_patients::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::PreOperativeAssessmentByPatients.def()
    }
}
