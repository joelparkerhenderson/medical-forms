...
#[sea_orm(table_name = "orthopaedics_waiting_list_cards")]
pub struct Model {
...
pub enum Relation {
    #[sea_orm(has_many = "super::orthopaedics_waiting_list_card_appointments::Entity")]
    OrthopaedicsWaitingListCardAppointments,
    #[sea_orm(has_many = "super::orthopaedics_waiting_list_card_grades::Entity")]
    OrthopaedicsWaitingListCardGrades,
    #[sea_orm(
...
impl Related<super::orthopaedics_waiting_list_card_appointments::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::OrthopaedicsWaitingListCardAppointments.def()
    }
}

impl Related<super::orthopaedics_waiting_list_card_grades::Entity> for Entity {
    fn to() -> RelationDef {
        Relation::OrthopaedicsWaitingListCardGrades.def()
    }
}
